 ...
 * Generated at: 2019-04-10 06:24:28 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t<h4>個人情報収集及び利用同意</h4>\n");
      out.write("\t\t\t\t<p class=\"desc\">\n");
      out.write("\t\t\t\t\tフォーメインは正確な相談処理のために最小限の個人情報を収集しています。<br>\n");
      out.write("\t\t\t\t\t下の内容を確認した後、個人情報の提供及び活用に同意してください。\n");
      out.write("\t\t\t\t</p>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<!-- //타이틀 영역 -->\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t\t<h5>個人情報の提供及び活用に対する同意</h5>\n");
      ...
      out.write("\t\t\t\t\t<form name=\"submitForm\" method=\"post\" action=\"/mjpn/community/cs_info.do\">\n");
      out.write("\t\t\t\t\t\t<input type=\"checkbox\" id=\"check0101\" name=\"chk\"><label for=\"check0101\"><span class=\"fc_2\">個人情報の収集および利用に同意します。</span> (必須の同意)</label>\n");
      out.write("\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t</span>\n");
      out.write("\t\t\t</div>\n");
      out.write("\n");
