 ...
 * Generated at: 2019-04-11 09:04:13 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<span>결제 금액 2% 적립</span>\n");
      out.write("\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t<p class=\"txt\">전 메뉴 결제 금액의 2%가 적립됩니다. 추후 적립은 <br>영수증 소지 시 3일 이내에 해당 매장에서 신청 가능합니다.</p>\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<p class=\"tit\">\n");
