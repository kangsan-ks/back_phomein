 ...
 * Generated at: 2019-04-03 04:32:09 UTC
...
return;
    ...
    try {
      ...
      out.write("<!-- \t\t\t\t<h4>フォーメインが作りあ <br>\n");
      out.write("\t\t\t\tげる世界<br> -->\n");
      out.write("\t\t\t\t<em>PHOEVER CSR</em></h4>\n");
      out.write("\t\t\t\t<p class=\"desc\">\n");
      out.write("\t\t\t\t\t冷めない熱い心で暖かい今日、<br>\n");
      out.write("\t\t\t\t\t暖かい世界を作ります。\n");
      out.write("\t\t\t\t</p>\n");
      out.write("\t\t\t\t<p class=\"txt\">\n");
      out.write("\t\t\t\t\tフォーメインは信頼される模範<br>\n");
      out.write("\t\t\t\t\t企業という一念の下、<br>\n");
      out.write("\t\t\t\t\t倫理経営を基に恵まれない階層や開発途<br>\n");
      out.write("\t\t\t\t\t上国の子供の救援に力を貸しています。\n");
      out.write("\t\t\t\t</p>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div class=\"csr_cont\">\n");
      out.write("\t\t\t\t<h5>活動紹介</h5>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"tit\">フォーメイン、新米のライスヌードル4,536ボックスを寄付</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\tフォーメイン本社では新米のみを使用して独自開発に成功した新米のライスヌードルをお店で披露することに先立って、社会的弱者層のために1億8千万ウォン相当のライスヌードル4,536ボックスを寄付しました。\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li class=\"swiper_slide\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"tit\">「PHO EVER 2018」 職業体験メンタリング</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\tフォーメインは、社団法人グローバルビジョンと共に就職支援が必要な青少年を対象に\n");
      out.write("\t\t\t\t\t\t\t\t\t\tフォーメインで経験できる職業について学習及び実習を行う\n");
      out.write("\t\t\t\t\t\t\t\t\t\t職業体験メンタリング「PHO EVER 2018」を行いました。\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li class=\"swiper_slide\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"tit\">「浦項地震による被害住民への支援」活動に寄付</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\tフォーメインの公式フェイスブックで浦項地震による被害住民への支援寄付キャンペーン「PHO U x 4」を\n");
      out.write("\t\t\t\t\t\t\t\t\t\t行って募金された基金の4培を「希望ブリッジ全国災害救護協会」に寄付しました。\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li class=\"swiper_slide\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"tit\">「新生児を助ける 帽子編みキャンペーン」 に参加 </span>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\tフォーメイン本社の役職員及び加盟店は低体重や栄養不足の新生児たちの体温を維持し、\n");
      out.write("\t\t\t\t\t\t\t\t\t\tあたたかい生命の力を養うために200個余りの帽子を製作してセーブ・ザ・チルドレンに寄付しました。\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li class=\"swiper_slide\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"tit\">城南地域児童センターに「幸福ギフトボックス」を届ける</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t城南地域児童センター3か所にフォーメイン本社の役職員が荷造りした「幸福ギフトボックス」\n");
      out.write("\t\t\t\t\t\t\t\t\t\t100箱をお届けし、子供たちと一緒に生春巻きを作って夕食を楽しみながらあたたかなひとときを過ごしました。\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li class=\"swiper_slide\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"tit\">ハビタット「希望の家作り」基金活動を後援</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t地域社会に寄与し、無住宅低所得層家庭を援助するためフォーメインの役職員たちと共に\n");
      out.write("\t\t\t\t\t\t\t\t\t\t心をひとつにしてハビタットに基金をお渡ししました。\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li class=\"swiper_slide\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"tit\">ハビタット「希望の家作り」建築ボランティア</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t無住宅低所得層の家庭を援助し暖かい家をプレゼントするため\n");
      out.write("\t\t\t\t\t\t\t\t\t\tフォーメインの役職員と一緒に汗を流しながら「希望の家作り」建築ボランティア活動を行いました。\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li class=\"swiper_slide\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"tit\">「愛の練炭配達」ボランティア</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\tフォーメイン本社の役職員みんなが「愛の練炭配達」ボランティア活動に参加して\n");
      out.write("\t\t\t\t\t\t\t\t\t\t「社団法人 暖かい 韓半島、愛の練炭分かち合い運動」に練炭5,000枚を寄贈し、\n");
      out.write("\t\t\t\t\t\t\t\t\t\t京畿道城南市金土洞の低所得世帯に練炭1,500枚を直接お届けしました。\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li class=\"swiper_slide\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"tit\">世界子ども救援基金をお渡しする</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t業界初にユニセフと寄付協約を結んで援助の手を必要とする\n");
      out.write("\t\t\t\t\t\t\t\t\t\t世界貧困児童たちに小さな希望になることを願いながら\n");
      out.write("\t\t\t\t\t\t\t\t\t\t世界子ども救助基金をお渡しする意味深いイベントを行いました。\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t</ul>\n");
