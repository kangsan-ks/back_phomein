 ...
 * Generated at: 2019-04-11 07:29:44 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<h2 class=\"h2-type\">브랜드 소개</h2>\n");
      ...
      out.write("\t\t\t\t\t<p class=\"tit\">쌀국수는 <span>포메인</span></p>\n");
      ...
      out.write("\t\t\t\t\t\t<p class=\"txt01 load-fadein\">2006년 정자본점으로 시작된 포메인의 <br>크고 작은 순간들이 모여</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt02 load-fadein\">2019년, 더욱 단단해진 경쟁력으로 <span>지금 이 자리에 서 있습니다.</span></p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt03 load-fadein\">동종업계의 타 브랜드가 너나 할 것 없이 유행을 좇을 때 <br>원칙과 정직함이라는 중심을 잃지 않고 도전을 이어나가는 것, <br>따라 할 수는 있어도 따라 올 수 없는 <br>차이를 만드는 힘입니다.</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt04 load-fadein\">지금, 여기, 어디에도 없는 포메인이 당신의 곁에 있습니다.</p>\n");
      ...
      out.write("\t\t\t\t\t<p class=\"txt\">베트남 요리, <span><em>31</em>가지 감동을 담다!</span></p>\n");
      out.write("\t\t\t\t\t<a href=\"/brand/menu/menu_list.do\" class=\"btn-all-menu\">전체메뉴 보기</a>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<!-- //brand-info -->\n");
      out.write("\t\t</div>\n");
