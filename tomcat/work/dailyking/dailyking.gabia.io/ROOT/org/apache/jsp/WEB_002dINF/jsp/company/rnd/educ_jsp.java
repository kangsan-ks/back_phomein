 ...
 * Generated at: 2019-04-03 01:16:19 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<h2 class=\"h2-type\">전문교육장</h2>\n");
      ...
      out.write("\t\t\t\t\t<h3 class=\"h3-type load-fadein\">동종업계 최초, 전문교육장 운영</h3>\n");
      ...
      out.write("\t\t\t\t\t\t<p class=\"tit load-fadein\">체계적인 교육, 13년의 노하우 전수</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt load-fadein\">포메인 전문교육장에서는  포메인 메뉴 조리법은 물론 식자재 및 주방 위생 관리법, 고객 응대, POS 사용, 식자재 발주 등 <br> 포메인 운영에 있어 필요한 모든 사항을 배우고 익힐 수 있습니다. <br>\n");
      out.write("\t\t\t\t\t\t또한 담당 슈퍼바이저와의 지속적인 사후관리로 믿고 함께할 수 있는 상생을 실천합니다.</p>\n");
