 ...
 * Generated at: 2019-03-10 12:21:29 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t<li>- 누구든지 인터넷 홈페이지 운영자 또는 관리자의 사전 동의 없이 인터넷 홈페이지에서자동으로 전자우편주소를 수집하는 프로그램이나 그 밖의 기술적 장치를 이용하여 전자우편주소를 수집하여서는 아니 된다.</li>\r\n");
      ...
      out.write("\t\t\t\t<ul class=\"txt\">\r\n");
      out.write("\t\t\t\t\t<li>- 다음 각 호의 어느 하나에 해당하는 자는 1년 이하의 징역 또는 1천만원 이하의 벌금에 처한다.\r\n");
      out.write("\t\t\t\t\t\t<ol>\r\n");
      out.write("\t\t\t\t\t\t\t<li>5. 제50조의 2를 위반하여 전자우편주소를 수집·판매·유통하거나 정보 전송에 이용한 자.</li>\r\n");
      out.write("\t\t\t\t\t\t</ol>\r\n");
      out.write("  \t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t</ul>\r\n");
      out.write("\t\t\t</div>\r\n");
