 ...
 * Generated at: 2019-03-29 00:52:46 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t<h4>동종업계 최초,<br>전문교육장 운영</h4>\n");
      ...
      out.write("\t\t\t\t\t<h5>체계적인 교육,<br>13년의 노하우 전수</h5>\n");
      out.write("\t\t\t\t\t<p class=\"txt\">\t\n");
      out.write("\t\t\t\t\t\t포메인 전문교육장에서는 포메인 메뉴 조리법은 물론 <br>식자재 및 주방 위생 관리법, 고객 응대, POS 사용,<br>\n");
      out.write("\t\t\t\t\t\t식자재 발주 등 포메인 운영에 있어 필요한 모든 사항을 <br>\n");
      out.write("\t\t\t\t\t\t배우고 익힐 수 있습니다. 또한 담당 슈퍼바이저와의 지속적인 <br>\n");
      out.write("\t\t\t\t\t\t사후관리로 믿고 함께할 수 있는 상생을 실천합니다.\n");
      out.write("\t\t\t\t\t</p>\n");
