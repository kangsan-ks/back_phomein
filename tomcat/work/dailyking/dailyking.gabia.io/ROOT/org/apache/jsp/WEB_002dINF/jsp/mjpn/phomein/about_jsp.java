 ...
 * Generated at: 2019-04-03 04:32:01 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t<h4>ライスヌードルはフ<br>ォーメイン</h4>\n");
      ...
      out.write("\t\t\t\t\t2006年、亭子本店からスタートしたフォー<br>\n");
      out.write("\t\t\t\t\tメインの大小様々な瞬間が積もり積もって \n");
      out.write("\t\t\t\t\t<strong><span>2019年、<br>より強くなった競争力で<br>今ここに立っています。</span></strong>\n");
      out.write("\t\t\t\t</p>\n");
      out.write("\t\t\t\t<p class=\"txt2\">\t\n");
      out.write("\t\t\t\t\t同種業界の他ブランドが誰彼無しに流行を追う時原則<br>\n");
      out.write("\t\t\t\t\tと正直さという中心を失わず挑戦し続けること、<br>\n");
      out.write("\t\t\t\t\t真似は出来ても追いつかれない差を付ける力です。\n");
      out.write("\t\t\t\t\t<em>今、ここ、どこにもないフォーメイン<br>があなたのそばにいます。</em>\n");
      out.write("\t\t\t\t<p>\n");
      out.write("\t\t\t\t<p class=\"img\"><img src=\"../common/images/content/img_about_1.jpg\" alt=\"\"></p>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div class=\"about_menu\">\n");
      out.write("\t\t\t\t<span>ベトナム料理、<br><em>31種の感動を盛り込む</em></span>\n");
      out.write("\t\t\t\t<a href=\"/mjpn/menu/menu_list.do\" class=\"link_menu\">メニュー表示</a>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<!-- //content -->\n");
      out.write("\t</div> \n");
