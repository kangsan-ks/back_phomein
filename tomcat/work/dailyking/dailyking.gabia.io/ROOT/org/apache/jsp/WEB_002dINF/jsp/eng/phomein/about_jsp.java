 ...
 * Generated at: 2019-04-08 08:52:54 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<p class=\"txt02 load-fadein\">With stronger competitiveness in 2019,<span>Phomein has greatly grown</span></p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt03 load-fadein\">Other brands in the food service industry run after a trend without exception.<br>\n");
      out.write("On the basis of principles and honesty,<br>\n");
      out.write("Phomein has taken on challenges and now has strong competitveness.<br>\n");
      out.write("Thanks to the efforts, Phomein has its unrivalled competitiveness.</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt04 load-fadein\">Now and here, the only Phomein is  with you.</p>\n");
