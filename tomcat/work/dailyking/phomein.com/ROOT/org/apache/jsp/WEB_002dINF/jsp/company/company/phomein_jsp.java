 ...
 * Generated at: 2021-02-26 10:24:01 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<h2 class=\"h2-type\">포메인</h2>\n");
      ...
      out.write("\t\t\t\t\t\t<p class=\"txt01 load-fadein\">올해 15주년을 맞이한 포메인은 한국인의 입맛에 맞는 레시피 개발로<br>국내 베트남 쌀국수 대중화를 이끈 대한민국 대표 쌀국수 전문 브랜드입니다.</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt02 load-fadein\">국내 130여 개의 매장을 보유한 포메인은 현대그린푸드와의 ‘안전한 식자재 공급’ MOU 체결, <br>베트남 현지 법인 공장 포시즌(PHO SEASON) 설립을 통한 햅쌀 쌀국수 개발 및 제조로 <br>‘안전한 식재료∙정직한 먹거리’ 약속을 지켜가고 있습니다.</p>\n");
