 ...
 * Generated at: 2020-01-20 08:18:56 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t<p class=\"txt03 load-fadein\">With undying sincerity, PHOMEIN brings warmth to your today and to your world.</p>\n");
      ...
      out.write(" and based on the firm ethical management,<br>\n");
      out.write(" Phomein is supporting aids to underprivileged groups<br>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"data-txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\tTogether with Global Vision, Phomein conducted the job experience mentoring, 'PHO EVER 2018' to learn/practice the job that can be experienced in Phomein, targeting the adolescents in need of employment support.\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"data-txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t'PHO x 4', a donation campaign to help the Pohang earthquake victims, was conducted in the Official Facebook Page of Phomein and consequently, a quadruple of the collected fund was donated to the Pohang earthquake victims.\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"data-tit\">'Participation in Save the Children's Hat-knitting Campaign 'Knit One Save One'</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"data-txt\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"data-tit\">'Happy Gift Box' Delivery to Seongnam Regional Children's Center</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"data-txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\tOur head office executives and employees packaged Happy Gift Boxes and delivered them to three Regional Children's Centers in Seongnam and shared warm meals with children by preparing Phomein's summer rolls together.\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"data-txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\tThe Phomein staff members delivered funds to Habitat to give back to the local communities and be of help to non-homeowners with low income.\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"data-tit\">Habitat 'Hopeful House Building' Fund sponsorship</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"data-txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\tThe Phomein staff members conducted a Habitat program to build houses and present them to non-homeowners with low income so that they have a warm place to live in.\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"data-txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\tAll Phomein staff members participated in 'Sharing Love with Briquettes' campaign and donated 5,000 briquettes to LOVECOAL corporation's briquette delivering campaign, and we've visited underprivileged families' homes in Geumto-dong, Seongnam-si, Gyeonggi-do and delivered 1,500 briquettes.\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"data-txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\tPhomein was the first in the field to have an agreement with UNICEF for fund donation. And with UNICEF, we held a meaningful event where our company delivered donation funds to aid the world children in hopes to present children in poverty with a beacon of light.\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
