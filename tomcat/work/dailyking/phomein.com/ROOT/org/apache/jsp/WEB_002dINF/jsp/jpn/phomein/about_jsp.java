 ...
 * Generated at: 2020-12-31 18:11:20 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<h2 class=\"h2-type\">ブランドご紹介</h2>\n");
      ...
      out.write("\t\t\t\t\t<p class=\"tit\">ライスヌードルはフ<br>ォーメイン</p>\n");
      ...
      out.write("\t\t\t\t\t\t<p class=\"txt01 load-fadein\">2006年、亭子本店からスタートしたフォーメインの<br>\n");
      out.write("大小様々な瞬間が積もり積もって</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt02 load-fadein\">2021年、より強くなった競争力で<br>\n");
      out.write("今ここに立っています。</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt03 load-fadein\">同種業界の他ブランドが誰彼無しに流行を追う時<br>\n");
      out.write("原則と正直さという中心を失わず挑戦し続けること、<br>\n");
      out.write("真似は出来ても追いつかれない差を付ける力です。</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt04 load-fadein\">今、ここ、どこにもないフォーメインがあなたのそばにいます。</p>\n");
      ...
      out.write("\t\t\t\t\t<p class=\"txt\">ベトナム料理、<span><em>31</em>種の感動を盛り込む</span></p>\n");
      out.write("\t\t\t\t\t<a href=\"/jpn/menu/menu_list.do\" class=\"btn-all-menu\">メニュー表示</a>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<!-- //brand-info -->\n");
      out.write("\t\t</div>\n");
