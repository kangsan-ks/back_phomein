 ...
 * Generated at: 2021-02-26 09:08:43 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t<li class=\"actived\"><a href=\"#\">상품권 안내</a></li>\n");
      out.write("\t\t\t\t\t<li><a href=\"/brand/phomein/coupon_02.do\">상품권 교환 신청</a></li>\n");
      out.write("\t\t\t\t</ul>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<!-- //page-tab -->\n");
      ...
      out.write("\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/purchase_img_01.png\" alt=\"아이콘1\" /></p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"tit\">현금 구매</p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"txt\">포메인 고객센터를 통해 가능합니다. </p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"tel\">문의 전화 : 1899-2422</p>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/purchase_img_02.png\" alt=\"아이콘2\" /></p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"tit\">마일리지 구매</p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"txt\">마일리지가 10,000점 이상일 경우 교환 가능하며<br>마일리지 전환을 통한 상품권 구매는<br>포메인 홈페이지에서 온라인 신청서 작성 후 가능합니다. </p>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<!-- //purchase -->\n");
      out.write("\n");
      out.write("\t\t\t\t<div class=\"mileag-procedure\">\n");
      out.write("\t\t\t\t\t<h4><span>마일리지</span> 구매 절차</h4>\n");
      out.write("\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/mileag_procedure_01.png\" alt=\"아이콘1\" /></p>\n");
      out.write("\t\t\t\t\t\t\t<p class=\"tit\">포메인<br>홈페이지 접속</p>\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/mileag_procedure_02.png\" alt=\"아이콘2\" /></p>\n");
      out.write("\t\t\t\t\t\t\t<p class=\"tit\">휴대폰 본인인증 후<br>온라인 신청서 작성</p>\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/mileag_procedure_03.png\" alt=\"아이콘3\" /></p>\n");
      out.write("\t\t\t\t\t\t\t<p class=\"tit\">우편 발송 & 수취</p>\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/mileag_procedure_04.png\" alt=\"아이콘4\" /></p>\n");
      out.write("\t\t\t\t\t\t\t<p class=\"tit\">상품권 사용</p>\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t<a href=\"/brand/phomein/coupon_02.do\" class=\"btn btn-01 type-01\">상품권 교환 신청</a>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t<div class=\"point-guide\">\n");
      out.write("\t\t\t\t\t<h4>포메인 상품권 사용 안내</h4>\n");
      out.write("\t\t\t\t\t<ul class=\"txt-list\">\n");
      out.write("\t\t\t\t\t\t<li>본 상품권은 포메인 전 매장에서 현금과 동일하게 사용 가능하며 타 상품권과 동시 사용이 가능합니다.</li>\n");
      out.write("\t\t\t\t\t\t<li>본 상품권의 유효기간은 상품권의 뒷면을 확인해 주시기 바랍니다.</li>\n");
      out.write("\t\t\t\t\t\t<li>본 상품권은 현금으로 교환하실 수 없습니다.</li>\n");
      out.write("\t\t\t\t\t\t<li>권면금액의 80% 이상 사용 시 현금 잔액을 돌려받을 수 있습니다.</li>\n");
      out.write("\t\t\t\t\t\t<li>수취하신 상품권의 도난, 분실, 훼손 등에 대해서는 당사에서 책임지지 않습니다.</li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t</div>\n");
