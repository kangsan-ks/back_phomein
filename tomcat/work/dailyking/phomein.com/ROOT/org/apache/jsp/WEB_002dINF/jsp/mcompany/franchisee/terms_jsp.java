 ...
 * Generated at: 2021-02-26 09:19:31 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t<h4>전화 가맹 문의</h4>\n");
      out.write("\t\t\t\t<p style=\"text-align:center; margin-top:25px;\">\n");
      out.write("\t\t\t\t\t<span>대표 번호 : 1899-2422 (연결 1)</span><br />\n");
      out.write("\t\t\t\t\t<span>직통 번호 : 031-780-1500</span><br />\n");
      out.write("\t\t\t\t\t<span style=\"font-size:13px;\">전화상담 가능 시간 : 평일 8:50AM ~ 18:00PM<br/>(점심시간 11:50 ~ 13:00)</span>\n");
      out.write("\t\t\t\t</p>\n");
      out.write("\t\t\t\t<p class=\"desc\" style=\"padding:10px 10px; border:1px solid #666; margin-top:30px;\">\n");
      out.write("\t\t\t\t\t* 온라인 문의 접수는 365일 24시간 운영합니다.<br>\n");
      out.write("\t\t\t\t\t* 접수된 문의는 담당자 배정 후 상담이 진행됩니다.<br>\n");
      out.write("\t\t\t\t\t* 어떤 문의든 신속하고 친절한 상담을 약속드립니다.\n");
      out.write("\t\t\t\t</p>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t<!-- 타이틀 영역 -->\n");
      ...
      out.write("\t\t\t\t\t포메인은 정확한 상담 처리를 위해 <br>\n");
      out.write("\t\t\t\t\t최소한의 개인정보를 수집하고 있습니다. <br>\n");
      out.write("\t\t\t\t\t아래의 내용을 확인하신 후 개인정보 <br>\n");
      out.write("\t\t\t\t\t제공 및 활용에 동의하여 주시기 바랍니다.\n");
      out.write("\t\t\t\t</p>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<!-- //타이틀 영역 -->\n");
      out.write("\t\t\t<div class=\"agree_area\">\n");
      out.write("\t\t\t\t<div class=\"agree_cont\">\n");
      out.write("\t\t\t\t\t<h5>개인정보 제공 및 활용에 대한 동의</h5>\n");
      ...
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<form name=\"submitForm\" method=\"post\" action=\"/mcompany/franchisee/info.do\">\n");
