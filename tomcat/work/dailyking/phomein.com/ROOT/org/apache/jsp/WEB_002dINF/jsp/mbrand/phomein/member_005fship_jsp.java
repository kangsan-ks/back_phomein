 ...
 * Generated at: 2021-02-26 09:19:41 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<option value=\"\" selected>멤버십 안내</option>\n");
      out.write("\t\t\t\t\t\t<option value=\"/mbrand/phomein/mileage_01.do\">마일리지 조회</option>\n");
      out.write("\t\t\t\t\t\t<option value=\"/mbrand/phomein/mileage_03.do\">마일리지 통합</option>\n");
      out.write("\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t<!-- //셀렉트 박스 -->\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t<div class=\"member_intro\">\n");
      out.write("\t\t\t\t<div class=\"tit_area\">\n");
      out.write("\t\t\t\t\t<h4>포메인 멤버십 등록</h4>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"cont\">\n");
      out.write("\t\t\t\t\t<span class=\"img\"><img src=\"../common/images/content/img_membership.png\" alt=\"\"></span>\n");
      out.write("\t\t\t\t\t<p class=\"txt\">\n");
      out.write("\t\t\t\t\t\t포메인 전 매장에서 <br>\n");
      out.write("\t\t\t\t\t\t휴대전화번호 입력을 통해<br> \n");
      out.write("\t\t\t\t\t\t간편하게 멤버십 등록이 <br>\n");
      out.write("\t\t\t\t\t\t가능합니다.\n");
      out.write("\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t</div> \n");
      out.write("\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>적립</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<span>결제 금액 1% 적립</span>\n");
      out.write("\t\t\t\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t\t\t\t전 메뉴 결제 금액의 1%가 적립됩니다. <br>\n");
      out.write("\t\t\t\t\t\t\t\t\t추후 적립은 영수증 소지 시 3일 이내에 해당\n");
      out.write("\t\t\t\t\t\t\t\t\t매장에서 신청 가능합니다.\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li class=\"no2\">\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>사용</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<span>2,000마일리지 적립시<br>500마일리지 사용가능</span>\n");
      out.write("\t\t\t\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t\t\t\t2,000 마일리지 이상 적립 시 500 마일리지 단위로\n");
      out.write("\t\t\t\t\t\t\t\t\t사용 가능합니다. 마일리지는 결제 시 사용 가능하며,\n");
      out.write("\t\t\t\t\t\t\t\t\t무단도용 사용을 방지하기 위해 본인 인증\n");
      out.write("\t\t\t\t\t\t\t\t\tSMS 절차를 거쳐 사용 할 수 있습니다.  <br>\n");
      out.write("\t\t\t\t\t\t\t\t\t(멤버십 등록 휴대전화 필참)\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li class=\"no3\">\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>조회</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"/mbrand/phomein/mileage_01.do\" class=\"btn_tyn c_black\">마일리지 조회</a>\n");
      out.write("\t\t\t\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t\t\t\t마일리지 적립 즉시 카카오톡, SMS로 당일 적립\n");
      out.write("\t\t\t\t\t\t\t\t\t마일리지, 누적 마일리지 현황이 발송되며\n");
      out.write("\t\t\t\t\t\t\t\t\t홈페이지에서도 조회 가능합니다.\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li class=\"no4\">\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>상품권 교환</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"/mbrand/phomein/coupon_02.do\" class=\"btn_tyn c_black\">상품권 교환 신청</a>\n");
      out.write("\t\t\t\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t\t\t\t1만 마일리지를 사용하여 포메인 상품권\n");
      out.write("\t\t\t\t\t\t\t\t\t1만원권으로 교환이 가능 합니다.\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      ...
      out.write("\t\t\t\t\t<span class=\"tit\">마일리지 이관</span>\n");
      out.write("\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t<li><span>\n");
      out.write("\t\t\t\t\t\t\t기존 미등록 포인트카드는 &lt;마일리지 통합&gt; 기능을 통하여 합산 가능 합니다.<br>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"/mbrand/phomein/mileage_03.do\" class=\"btn_tyn c_black\">마일리지 통합하기 신청</a>\n");
      out.write("\t\t\t\t\t\t</span></li>\n");
      out.write("\t\t\t\t\t\t<li><span>본인의 마일리지를 타인에게 이관 할 수 없습니다.</span></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"txt_list\">\n");
      out.write("\t\t\t\t\t<span class=\"tit\">유의사항</span>\n");
      out.write("\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t<li><span>\n");
      out.write("   \t\t\t\t\t\t\t유효기간  :  마일리지의 유효기간은 적립 년도 기준, 3년이 되는 해 12월 31일 24시에 일괄 소멸됩니다.<br>\n");
      out.write("    \t\t\t\t\t\t<em>예 ) 2018년 7월 2일 적립 마일리지 > 2021년 12월 31일 24시 일괄 소멸</em>\n");
      out.write("    \t\t\t\t\t</span></li>\n");
      out.write("\t\t\t\t\t\t<li><span>타 쿠폰이나 할인 서비스와 중복 사용 불가 합니다.</span></li>\n");
      out.write("\t\t\t\t\t\t<li><span>배달서비스 이용 시 마일리지 적립 / 사용이 제한됩니다.</span></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"txt_list\">\n");
      out.write("\t\t\t\t\t<span class=\"tit\">기타</span>\n");
      out.write("\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t<li><span>멤버쉽 관련 오류 및 문의사항은 아래 온라인 접수 또는 본사로 문의해 주시기 바랍니다.</span></li>\n");
      out.write("\t\t\t\t\t\t<li><span>대표번호 031-780-1570~2</span></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t\n");
