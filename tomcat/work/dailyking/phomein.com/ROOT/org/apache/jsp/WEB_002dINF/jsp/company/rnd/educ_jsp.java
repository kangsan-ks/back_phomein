 ...
 * Generated at: 2021-02-26 08:59:37 UTC
...
public final class educ_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<div class=\"visual\" style=\"background-image:url('/brand/images/sub/bg_08.png');\"></div>\n");
      out.write("\t\t\t<h2 class=\"h2-type\">교육시스템</h2>\n");
      out.write("\t\t\t<span class=\"txt\">포메인은 ‘안전한 식재료∙정직한 먹거리’를 약속하며<br>포메인만의 특별한 차이를 만들어갑니다.</span>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<!-- //page-title -->\n");
      out.write("\n");
      out.write("\t\t");
      ...
      out.write("\t\t\t\t\t<h3 class=\"h3-type load-fadein\">체계적이고 확실한 커리큘럼, 전문교육장 운영</h3>\n");
      out.write("\t\t\t\t\t<p class=\"txt load-fadein\">포메인은 신규 창업자 및 가맹점주들이 안정적인 매장 운영을 바탕으로 고객들에게 건강한 테이블을 전할 수 있도록 <br>[분당 정자본점]에 동종업계 최초로 전문교육장을 마련하여 체계적인 커리큘럼에<br>따른 매장 운영 교육을 진행하고 있습니다.</p>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t<!-- educ-box -->\n");
      out.write("\t\t\t\t<div class=\"inner02\">\n");
      out.write("\t\t\t\t\t<div class=\"educ-box\">\n");
      out.write("\t\t\t\t\t\t<p class=\"tit load-fadein\">체계적인 교육, 15년의 노하우 전수</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt load-fadein\">㈜데일리킹 전문교육장에서는 메뉴 조리법은 물론 식자재 및 주방 위생 관리법, 고객 응대,<br>POS 사용, 식자재 발주 등 매장 운영에 있어 필요한 모든 사항을 배우고 익힐 수 있습니다.<br>교육이 끝난 후에도 담당 슈퍼바이저와의 지속적인 사후관리로 믿고 함께할 수 있는 상생을 실천합니다.<br><br>또한 전문교육장에서는 트렌드 분석과 R&D 전문인력의 체계적인 신메뉴 개발로 꾸준한 매출 증대를 도모합니다. </p>\n");
      out.write("\t\t\t\t\t\t<div class=\"educ-visual\">\n");
      out.write("\t\t\t\t\t\t\t<div><img src=\"../images/content/educ_img_01.jpg\" alt=\"\"/></div>\n");
      out.write("\t\t\t\t\t\t\t<div><img src=\"../images/content/educ_img_02.jpg\" alt=\"\"/></div>\n");
      out.write("\t\t\t\t\t\t\t<div><img src=\"../images/content/educ_img_03.jpg\" alt=\"\"/></div>\n");
      out.write("\t\t\t\t\t\t\t<div><img src=\"../images/content/educ_img_04.jpg\" alt=\"\"/></div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<!-- //educ-box -->\n");
