 ...
 * Generated at: 2019-09-02 17:20:25 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<di class=\"cost\">\n");
      out.write("\t\t\t\t<div class=\"tit_area pb0\">\n");
      out.write("\t\t\t\t\t<h4>가맹 비용</h4>\n");
      out.write("\t\t\t\t\t<span class=\"txt fc_9\">단위 : 천원</span>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<!-- table -->\n");
      out.write("\t\t\t\t<div class=\"table_data_ty2\">\n");
      out.write("\t\t\t\t\t<table>\n");
      ...
      out.write("\t\t\t\t\t\t</colgroup>\n");
      out.write("\t\t\t\t\t\t<thead>\n");
      out.write("\t\t\t\t\t\t\t<th scope=\"col\"><span>구분</span></th>\n");
      out.write("\t\t\t\t\t\t\t<th scope=\"col\"><span>금액</span></th>\n");
      out.write("\t\t\t\t\t\t\t<th scope=\"col\"><span>내용</span></th>\n");
      out.write("\t\t\t\t\t\t</thead>\n");
      out.write("\t\t\t\t\t\t<tbody>\n");
      out.write("\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>가맹<br>가입비용</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>25,000</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>상표 및 휘장 사용권 부여</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>영업 지역 부여</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>메인 메뉴얼 사용 권한 부여</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>포메인 교육비 일체</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>인테리어</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>84,000<br>~ 110,000</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li class=\"fc_important\">평수별 평단가 / 예상금액\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<li>30평  :  2,800 / 84,000</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<li>35평  :  2,650 / 92,750</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<li>40평  :  2,500 / 100,000</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<li>45평  :  2,350 / 105,750</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<li>50평  :  2,200 / 110,000</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>가구(의, 탁자 등) 포함</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>별도공사\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<li>냉·난방 시설<br>(천정형 에어컨 권장)</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<li>철거, 배수, 덕트 공사, 전기 용량 및 가스 증설, 소방 시설 등</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<li>자재 변경 시</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"caution\">점포지 제반 상황에 따라서 추가 비용이 발생할 수 있음</span>\n");
      out.write("\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>주방 설비<br>및 기물</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>25,000<br>내외</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>주방 면적 약 8평 내외 기준</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>사기 그릇, 화구, 냉장고, 식기 세척기, 싱크대 등 각종 주방 물품 일체</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"caution\">점포지 제반 상황에 따라서 추가 비용이 발생할 수 있음</span>\n");
      out.write("\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>간판</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>8,000<br>내외</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>전면 간판(7,000 × 450mm) 1개 설치 시 기준이며, 간판 규격(size) 및 설치 개수에 따라서 비용이 상이하게 발생할 수 있음.</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>LED+갤브프레임</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>내부실사 비용 포함</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"caution\">점포지 제반 상황에 따라서 추가 비용이 발생할 수 있음</span>\n");
      out.write("\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>POS</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>1,280<br>~ 2,280<br>내외</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>메인 POS(듀얼 모니터) : <br>1,280,000원</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>추가 설치 품목\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<li>오더 POS : 1,000,000원</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<li>프린터기 : 200,000원</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>초도물품</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>2,000<br>내외</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>직원 유니폼, 메뉴판, 빌지 패드 등 기타 비품</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>임차비용</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>별도</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td></td>\n");
      out.write("\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t</tbody>\n");
      out.write("\t\t\t\t\t\t<tfoot>\n");
      out.write("\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>총액</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span><strong>약 140,280<br>~ 172,500</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td><span>Vat 별도</span></td>\n");
      out.write("\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t</tfoot>\n");
      out.write("\t\t\t\t\t</table>\n");
      out.write("\t\t\t\t</div>\n");
