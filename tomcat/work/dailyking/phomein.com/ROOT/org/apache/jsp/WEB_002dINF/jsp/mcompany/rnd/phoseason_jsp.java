 ...
 * Generated at: 2021-02-26 09:21:45 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsp.mcompany.rnd;
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<h3>포시즌 (PHO SEASON)</h3>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<!-- 상단비쥬얼 영역\n");
      ...
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<p style=\"text-align:right; font-size:12px; color:#888;\">* 베트남 롱안성에서 운영 중인 포시즌 공장 전경 이미지입니다.</p>\n");
      out.write("\n");
      out.write("\t\t\t\t<div class=\"intro_text\">\n");
      out.write("\t\t\t\t\t<strong>PHO SEASON</strong>\n");
      out.write("\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t2015년 ㈜데일리킹에서 설립한 베트남 현지 쌀국수 제조공장<br>\n");
      out.write("\t\t\t\t\t\t포시즌은베트남 쌀국수를 의미하는 포(Pho)와 향신료를 뜻하는<br>\n");
      out.write("\t\t\t\t\t\t시즈닝(Seasoning)의 합성으로 ‘포시즌’에는 사계절 내내 맛있게<br>\n");
      out.write("\t\t\t\t\t\t즐길 수 있는 고품질의 제품을 만든다는 기업 모토가 담겨 있습니다. \n");
      out.write("\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t포시즌은 3모작이 가능한 베트남 메콩델타 지역에서 1년 내내<br>\n");
      out.write("\t\t\t\t\t\t신선한 쌀을 공급받아 수년간의 연구로 개발한 기계건조 및<br>저온 숙성 기술로 햅쌀 쌀국수면 생산에 성공했습니다.<br>\n");
      out.write("\t\t\t\t\t\t또한 9가지 상급 천연 향신료를 사용한 육수용<br>허브백(Herb-Bags)을 생산하고 있습니다.\n");
      out.write("\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t수입 쌀국수면에 의존해온 국내 쌀국수 시장에서 쌀국수 브랜드가<br>\n");
      out.write("\t\t\t\t\t\t자체 기술개발로 쌀국수면을 생산·사용하는 브랜드는<br> 포메인과 포메인 RED가 유일합니다.<br>\n");
      out.write("\t\t\t\t\t\t포시즌 설립에 따른 포메인의 차별화는 국내뿐 아니라<br>세계 쌀국수 시장의 새로운 기준이 될 것입니다.\n");
      out.write("\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<div class=\"factory_img\">\n");
      out.write("\t\t\t\t\t<img src=\"../common/images/content/phoseason_factory01.png\" alt=\"\">\n");
      out.write("\t\t\t\t\t<img src=\"../common/images/content/phoseason_factory02.png\" alt=\"\">\n");
      out.write("\t\t\t\t\t<img src=\"../common/images/content/phoseason_factory03.png\" alt=\"\">\n");
      out.write("\t\t\t\t\t<img src=\"../common/images/content/phoseason_factory04.png\" alt=\"\">\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t<div class=\"cont\">\n");
      out.write("\t\t\t\t\t<strong>쌀 한 톨부터<br><em>쌀국수 한 그릇까지</em></strong>\n");
      out.write("\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t햅쌀 쌀국수면은 묵은쌀과 전분 또는 밀가루를 혼합해<br>\n");
      out.write("\t\t\t\t\t\t만든 기존 쌀국수면과는 전혀 다른 투명한 빛깔과<br>갓 지은 햅쌀밥 향을 느낄 수 있습니다.<br>\n");
      out.write("\t\t\t\t\t\t또한 깊고 진한 천연 향신료를 사용한 Herb-Bags과<br> 호주산 청정우로 매장에서 직접 14시간 우려낸 육수의 향과<br>\n");
      out.write("\t\t\t\t\t\t맛은 식재료가 중요해진 현대사회에 강력한 경쟁력이 됩니다.\n");
      out.write("\t\n");
      out.write("\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>1년 4계절, 햅쌀</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t\t\t\t쌀국수 건면 생산에 적합한 기후와 환경인 베트남,<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t특히 3모작이 가능한 메콩 델타 지역에서<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t1년 내내 신선한 쌀을 공급받습니다.<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t포메인 쌀국수면은 묵은 쌀이 아닌 햅쌀만을 사용해<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t쌀국수 건면을 만듭니다.\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>티 없이 맑은, 정제수</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t\t\t\t포메인 쌀국수면 제조 과정에서 햅쌀만큼 중요한 물 또한<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t포시즌의 정제 기술을 통해 잔류 의약품과<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t환경호르몬 등 70여 가지의 오염 물질을 제거한<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t깨끗한 물(정제수)을 사용 합니다.\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>독자적 기술, 기계 건조</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t\t\t\t노후화된 타 쌀국수 공장과 달리 포메인이 자체<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t개발한 기계 건조 기술로 위생적인 건조가 이뤄집니다.<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t이 과정에서 하얗고 투명한 빛깔은 살리고 햅쌀밥의<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t향을 고스란히 담아냅니다.\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>면발의 완성, 저온 숙성</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t\t\t\t불필요한 화학 첨가물을 사용하지 않기 위해<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t저온으로 숙성 과정을 거칩니다.<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t적당한 찰기와 부드러움, 면발의 쫄깃함을<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t배로 끌어 올려 주는 포메인의 기술이 집약되어 있습니다.\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>명품 육수, 허브백</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t\t\t\t9가지 상급 천연 향신료를 사용한<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t육수용 허브백(Herb-Bags)은 지속적인<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t품질개선 재정비를 실시합니다.<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t포메인이 최상의 육수의 맛과 질을 유지하는 비결입니다.\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t</ul>\n");
