 ...
 * Generated at: 2021-01-02 09:35:17 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<h2 class=\"h2-type\">About Phomein</h2>\n");
      ...
      out.write("\t\t\t\t\t<p class=\"tit\">The Best <br>Rice Noodle Restaurant Phomein</p>\n");
      out.write("\t\t\t\t\t<p class=\"txt\">The World’s Best Korean Vietnamese Restaurant Phomein</p>\n");
      out.write("\t\t\t\t\t<p class=\"img\"><img src=\"../images/common/brand_info_logo.png\" alt=\"logo\"/></p>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<!-- 20190225 수정 -->\n");
      out.write("\t\t\t\t<div class=\"inner02\">\n");
      out.write("\t\t\t\t\t<div class=\"page-box\">\n");
      out.write("\t\t\t\t\t\t<p class=\"txt01 load-fadein\">Starting at Jeongja Restaurant in 2006,<br>Phomein has had many experiences, big and small.</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt02 load-fadein\">With stronger competitiveness in 2021,<br><span>Phomein has accomplished great growth.</span></p>\n");
      ...
      out.write("\t\t\t\t\t\t<br><br>Wholesome rice noodles made from freshly harvested rice 365 days a year to<br>luxurious meat broth further deepened with quality improvement<br><span style=\"color:#222; font-size:21px;\">Phomein is it for rice noodles.</span></p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt03 load-fadein\">Other brands in the foodservice industry are busy chasing trends without exception.<br>On the basis of principles and honesty, Phomein has taken challenges and strengthened its competitiveness.<br>Thanks to these efforts, Phomein possesses unrivalled competitiveness as of now.</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt04 load-fadein\">Now and here, the one and only Phomein is with you.</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/brand_menu_img.jpg\" alt=\"쌀국수 이미지\" class=\"load-fadein\"/></p>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<!-- //20190225 수정 -->\n");
      out.write("\t\t\t\t<div class=\"all-menu\">\n");
      out.write("\t\t\t\t\t<p class=\"txt\"><em>31</em> kinds of Vietnamese dishes, <span>give you impression.</span></p>\n");
      out.write("\t\t\t\t\t<a href=\"/eng/menu/menu_list.do\" class=\"btn-all-menu\">ALL MENU VIEW</a>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<!-- //brand-info -->\n");
      out.write("\t\t</div>\n");
