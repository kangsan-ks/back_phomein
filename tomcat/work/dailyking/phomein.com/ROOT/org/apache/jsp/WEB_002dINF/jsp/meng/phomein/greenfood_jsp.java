 ...
 * Generated at: 2020-01-12 20:36:09 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t<h4>'Safe food Ingredients supply MOU' <br>with Hyundai Green Food</h4>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"content\">\n");
      out.write("\t\t\t\t\t<p class=\"txt1\">\n");
      out.write("\t\t\t\t\t\t'Phomein will make a healthy table with 'Hyundai Green Food', a comprehensive food company equipped with a ‘hazardous product blocking system’ of the Ministry of Food and Drug Safety\n");
      out.write("\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t<p class=\"txt2\">\n");
      out.write("\t\t\t\t\t\t<strong>Relief Phomein</strong>\n");
      out.write("\t\t\t\t\t\t<span>\n");
      out.write("\t\t\t\t\t\t\tPhomein and Hyundai Green Food signed a business agreement on the supply of safe food ingredients in August 2016.\n");
      out.write("\t\t\t\t\t\t\tPhomein is promoting the unification of distribution channels for all franchises, and you can check the 'Relief Phomein' certification mark at franchises that receive food ingredients through Hyundai Green Food.\n");
      out.write("\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t\t<span>\n");
      out.write("\t\t\t\t\t\t\t'Safe food Ingredients and Honest food’<br>\n");
      out.write("\t\t\t\t\t\t\tIt is a product certified with a scientific food safety system of Phomein and Hyundai Green Food for the safety of production and distribution processes.\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t</p>\n");
