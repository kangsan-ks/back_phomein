 ...
 * Generated at: 2021-02-26 08:54:20 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t<h4 style=\"font-size:50px; margin-bottom:50px;\">PHO SEASON</h4>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"con_main_img\">\n");
      out.write("\t\t\t\t\t<img src=\"../images/content/phoseason_main_img.png\" alt=\"\">\n");
      out.write("\t\t\t\t\t<p style=\"font-size:17px; text-align:right; margin:5px auto 0; width: 1800px;\">* 베트남 롱안성에서 운영 중인 포시즌 공장 전경 이미지입니다.</p>\n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t<p class=\"txt load-fadein\">2015년 ㈜데일리킹에서 설립한 베트남 현지 쌀국수 제조공장 포시즌은 베트남 쌀국수를 의미하는<br>포(Pho)와 향신료를 뜻하는 시즈닝(Seasoning)의 합성으로 ‘포시즌’에는 사계절 내내 맛있게 즐길 수 있는<br> 고품질의 제품을 만든다는 기업 모토가 담겨 있습니다.</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt load-fadein\">포시즌은 3모작이 가능한 베트남 메콩델타 지역에서 1년 내내 신선한 쌀을 공급받아<br>수년간의 연구로 개발한 기계건조 및 저온 숙성 기술로 햅쌀 쌀국수면 생산에 성공했습니다.<br>또한 9가지 상급 천연 향신료를 사용한 육수용 허브백(Herb-Bags)을 생산하고 있습니다.</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt load-fadein\">수입 쌀국수면에 의존해온 국내 쌀국수 시장에서 쌀국수 브랜드가 자체 기술개발로<br>쌀국수면을 생산 · 사용하는 브랜드는 포메인과 포메인 RED가 유일합니다.<br>포시즌 설립에 따른 포메인의 차별화는 국내뿐 아니라 세계 쌀국수 시장의 새로운 기준이 될 것입니다.</p>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"con_main_img\">\n");
      out.write("\t\t\t\t\t\t<img src=\"../images/content/phoseason_main_img_02.png\" alt=\"\">\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t<p class=\"txt load-fadein\">햅쌀 쌀국수면은 묵은쌀과 전분 또는 밀가루를 혼합해 만든 기존 쌀국수면과는 <br>전혀 다른 투명한 빛깔과 갓 지은 햅쌀밥 향을 느낄 수 있습니다.<br>또한 깊고 진한 천연 향신료를 사용한 Herb-Bags과 호주산 청정우로 매장에서 직접 14시간 우려낸<br>육수의 향과 맛은 식재료가 중요해진 현대사회에 강력한 경쟁력이 됩니다.</p>\n");
      out.write("\n");
