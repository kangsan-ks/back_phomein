 ...
 * Generated at: 2020-12-31 18:27:44 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<h2 class=\"h2-type\">CEO</h2>\n");
      ...
      out.write("\t\t\t\t\t<p class=\"tit\">CEO</p>\n");
      out.write("\t\t\t\t\t<!-- <p class=\"txt\">We will do our best to satisfy our customers.</p> -->\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t\t\t\tHello<br>\n");
      out.write("\t\t\t\t\t\t\tI am Kim Dae-il, CEO of DAILYKING INC.<br>\n");
      out.write("\t\t\t\t\t\t\tThank you for visiting Phomein.<br>\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt02\">\n");
      out.write("\t\t\t\t\t\t\t<span>Welcoming the 15th year as of today,<br>We will continue to keep our own principles.</span>\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt03\">\n");
      out.write("\t\t\t\t\t\t\t<span>\n");
      out.write("\t\t\t\t\t\t\t\tSince opening of the Head Store in Jeongja in 2006, we have fulfilled our promise of ‘Safe Food Ingredients and Honest Food’. We have steadily worked to honor it with the establishment of &lt;PHO SEASON&gt;, a rice noodle manufacturing factory in Vietnam and business agreement with &lt;Hyundai Green Food&gt;, a comprehensive food company which introduced the hazardous product blocking system in 2016. <br><br>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\tAs the result of 'our own principle', you will be able to meet Fresh Rice Noodles only at all franchise stores of Phomein in 2019. In the rice noodle market that depends on imported rice noodles mixed with old rice. Making a bowl of rice noodles only with fresh rice requires care and sincerity which heightened as the cooking process became more delicate.<br><br>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\tPlease experience the appropriate glutinosity, the softness, and the chewiness of Phomein’s Fresh Rice Noodles which were born with Phomein’s exclusive low-temperature ripening technique. This process helps to avoid using unnecessary chemical additives.<br><br>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\tEven with our reputation of being the best for a long time, we promise to serve fresh ingredients and healthy table every day without losing modesty. Thank you.\n");
      out.write("\t\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt04\">CEO of DAILYKING INC. Kim Dae-il</p>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<!-- //ceo-info -->\n");
