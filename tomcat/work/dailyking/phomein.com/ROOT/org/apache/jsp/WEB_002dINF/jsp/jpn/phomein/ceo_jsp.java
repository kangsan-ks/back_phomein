 ...
 * Generated at: 2021-01-01 10:10:28 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\tこんにちは。<br>\n");
      out.write("\t\t\t\t\t\t\t株式会社デイリーキングの代表、キム・デイルです。<br>\n");
      out.write("\t\t\t\t\t\t\tフォーメインをアクセスして頂き、有難うございます。<br>\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt02\">\n");
      out.write("\t\t\t\t\t\t\t<span>15年目の本日、<br> 今も私たちだけの原則は失いません。</span>\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt03\">\n");
      out.write("\t\t\t\t\t\t\t<span>\n");
      out.write("\t\t\t\t\t\t\t\t2006年亭子本店を開店後、「安全な食材の正直な食べ物」という原則で、これまでその約束を実践してきました。2015年ベトナム現地法人ライスヌードル製造工場の<フォーシーズン(PHO SEASON>の設立と、2016年危害商品遮断システムを導入している総合食品企業の<現代グリーンフード>との業務協約で絶えずに引き続いています。<br><br>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\tまた、「私たちだけの原則」の結実で、2019年よりフォーメインの全店でのみ新米ライスヌードルが味わえようになりました。古米で作った輸入ライスヌードル麺に依存したライスヌードル市場で、新米だけでライスヌードル一丁を作ること、料理過程が厳しくなっただけもっと濃くなった真心と本気を込めています。<br><br>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\tライスヌードル特有の麺の匂いがなくこぎれいに、フォーメインだけの低温熟成技術でしこしこするフォーメイン新米ライスヌードル麺を味わってみてください。<br><br>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t長年の時間、最高という名声の前でも謙遜さを失わずに、毎日新鮮な材料と元気な食卓を約束します。有難うございます。\n");
      out.write("\t\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt04\">㈱デイリーキング代表、キム・デイル(署名)</p>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<!-- //ceo-info -->\n");
