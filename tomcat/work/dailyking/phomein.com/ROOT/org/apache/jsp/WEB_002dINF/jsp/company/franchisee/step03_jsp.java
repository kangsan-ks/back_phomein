 ...
 * Generated at: 2021-02-26 09:08:27 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t<li><a href=\"/company/franchisee/step01.do\">브랜드 파워</a></li>\n");
      out.write("\t\t\t\t\t<li><a href=\"/company/franchisee/step02.do\">창업지원시스템</a></li>\n");
      out.write("\t\t\t\t\t<li class=\"actived\"><a href=\"#\">개설절차</a></li>\n");
      out.write("\t\t\t\t</ul>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<!-- //page-tab -->\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t\t\t<h4>가맹 절차</h4>\n");
      out.write("\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t<span>1</span>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_step_list_01.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"tit\">가맹 문의</p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"txt\">창업 문의 상담 신청<br>전반적인 사업 설명</p>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t<span>2</span>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_step_list_02.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"tit\">시장 조사</p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"txt\">가맹점 후보지 선정</p>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t<span>3</span>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_step_list_03.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"tit\">입점지 선정</p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"txt\">상권, 입지,사업<br>타당성 분석</p>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t<span>4</span>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_step_list_04.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"tit\">가맹 계약</p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"txt\">정보공개서 제공<br>가맹 계약 체결</p>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t<span>5</span>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_step_list_05.png\" alt=\"ico\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"tit\">인력 채용</p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"txt\">주방/홀 직원 채용</p>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t<span>6</span>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_step_list_06.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"tit\">매장 시설 공사</p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"txt\">인테리어/간판/<br>주방설비 계약 및 공사</p>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t<span>7</span>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_step_list_07.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"tit\">본점 교육</p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"txt\">이론, 실습, 현장 교육<br>(분당 정자본점 전문교육장)</p>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t<span>8</span>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_step_list_08.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"tit\">영업 준비</p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"txt\">물품 공급/<br>인∙허가 증명서 발급/<br>전체 점검</p>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t<span>9</span>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_step_list_09.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"tit\">개점</p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"txt\">온∙오프라인 홍보<br>오픈 이벤트 진행</p>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t<span>10</span>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_step_list_10.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"tit\">사후 관리</p>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"txt\">안정적인 물품 공급<br>슈퍼바이저 지원</p>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t<li style=\"padding-top:0; \">\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"http://www.phomein.com/company/franchisee/terms.do\" style=\"display:block; width: 100%; height: 100%; padding-top:40px;\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"tit\" style=\"font-size:23px; margin-top:0;\">가맹 상담</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p style=\"display:inline-block; font-size:15px; margin-top:20px; padding:6px 18px; background-color:#525252; color:#fff; border-radius:4px;\">바로가기</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\" style=\"font-size:18px; margin-top:20px;\">대표 전화<br>1899-2422</p>\n");
      out.write("\t\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t</ul>\n");
      out.write("<!-- \t\t\t\t\t\t<div class=\"txt-info\">\n");
      out.write("\t\t\t\t\t\t\t<p class=\"tit\">대한민국 쌀국수 전문 브렌드 포메인</p>\n");
      out.write("\t\t\t\t\t\t\t<p class=\"txt\">동종업계 내 전체 매장 수 1위</p>\n");
      out.write("\t\t\t\t\t\t</div> -->\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<!-- //step-list -->\n");
