 ...
 * Generated at: 2020-01-14 04:42:29 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<h3 class=\"h3-type\">個人情報収集及び利用同意</h3>\n");
      out.write("\t\t\t\t\t\t<span class=\"txt\">フォーメインは正確な相談処理のために最小限の個人情報を収集しています。<br>下の内容を確認した後、個人情報の提供及び活用に同意してください。</span>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t<div class=\"agree-con\">\n");
      out.write("\t\t\t\t\t\t<div class=\"con-box\">\n");
      out.write("\t\t\t\t\t\t\t<h4>個人情報の提供及び活用に対する同意</h4>\n");
      out.write("\t\t\t\t\t\t\t<p>本会社は相談のために下の個人情報を収集及び利用しています。<br>\n");
      out.write("\t\t\t\t\t\t\t1. 個人情報収集項目(必須)：名前、電子メール、連絡先<br>\n");
      out.write("\t\t\t\t\t\t\t2. 個人情報の収集及び利用目的：顧客の声に対する相談<br>\n");
      out.write("\t\t\t\t\t\t\t3. 個人情報保有期間：個人情報を収集後、利用目的が達成されれば最大30日内に情報を破棄<br>\n");
      out.write("\t\t\t\t\t\t\t* あなたは個人情報の提供及び活用に対して同意しない権利がありますが、同意を拒否するとサービスご利用に制限があり得ます。</p>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<form name=\"submitForm\" method=\"post\" action=\"/jpn/community/cs_info.do\">\n");
      out.write("\t\t\t\t\t\t<p class=\"chk-type01\"><input type=\"checkbox\" id=\"check0101\" name=\"chk\"><label for=\"check0101\"><span></span>個人情報の収集および利用に同意します。<strong>(必須の同意)</strong></label></p>\n");
      out.write("\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t<!-- btn-box -->\n");
      out.write("\t\t\t\t\t<div class=\"btn-box mt50\">\n");
      out.write("\t\t\t\t\t\t<a href=\"javascript:;\" class=\"btn-01 type-01\" id=\"agreeBtn\">確認</a>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<!-- //btn-box -->\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      ...
      out.write("\t\t\talert(\"個人情報の収集および利用に同意してください。\");\n");
      out.write("\t\t\treturn false;\n");
      out.write("\t\t} else {\n");
