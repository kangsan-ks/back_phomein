 ...
 * Generated at: 2021-02-26 10:24:45 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<div class=\"visual\" style=\"background-image:url('/company/images/content/sub_visual_01_1.jpg');\"></div>\n");
      out.write("\t\t\t<h2 class=\"h2-type\">㈜데일리킹</h2>\n");
      ...
      out.write("\t\t\t\t\t<p class=\"img\"><img src=\"/company/images/common/dailyking_logo.png\" alt=\"dailyking logo\" class=\"load-fadein\"/></p>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t<div class=\"inner02\">\n");
      out.write("\t\t\t\t\t<div class=\"page-box\">\n");
      out.write("\t\t\t\t\t\t<p class=\"txt01\">\n");
      out.write("\t\t\t\t\t\t\t㈜데일리킹은 2006년 설립되어 국내에 쌀국수 프랜차이즈 브랜드<br>‘포메인’을 정착시키고, 베트남 요리 외식 문화를 대중화시킨 법인 기업입니다.\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt02\">\n");
      out.write("\t\t\t\t\t\t\t㈜데일리킹은 ‘안전한 식재료 정직한 먹거리’ 이념 하에 ‘현대그린푸드’와 업무협약을 체결,<br>각 가맹점에 안전하고 신선한 식자재를 공급하고 있습니다.\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt02\">\n");
      out.write("\t\t\t\t\t\t\t또한 2015년 베트남 현지법인 쌀국수 공장 ‘포시즌(PHO SEASON)을 설립하여<br>\n");
      out.write("\t\t\t\t\t\t\t9가지 상급 천연 향신료를 사용한 육수용 허브백(Herb-Bags) 생산, 수년간의 연구개발 끝에 ‘햅쌀 쌀국수면’ 개발에 성공했습니다.<br>\n");
      out.write("\t\t\t\t\t\t\t묵은쌀로 만든 수입 쌀국수면에 의존한 쌀국수 시장에서 ‘햅쌀 쌀국수면’이 가지는 깨끗함과 건강함은<br>\n");
      ...
      out.write("\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"/company/images/content/dailyking_img_01.png\" alt=\"\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\">햅쌀과 물 외에 불필요한 화학 첨가물을<br>첨가하지 않았습니다.</p>\n");
      out.write("\t\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"/company/images/content/dailyking_img_02.png\" alt=\"\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\">묵은쌀, 전분, 밀가루를 혼합한<br>수입 쌀국수면에서 나는 특유의 잡냄새가 없습니다.</p>\n");
      out.write("\t\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"/company/images/content/dailyking_img_03.png\" alt=\"\"/></p>\n");
      ...
      out.write("\t\t\t\t\t\t\t묵은쌀과 전분, 밀가루를 혼합해 만든 수입 쌀국수면을 사용하는 국내 쌀국수 시장에서 햅쌀과 정제수만으로 쌀국수면을 만든다는<br>\n");
      out.write("\t\t\t\t\t\t\t발상의 전환은 누군가에게는 무모해 보였을지도, 누군가에게는 불필요한 고난의 길이었을지도 모릅니다. <br><br>\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t그러나 ㈜데일리킹에 있어 ‘포시즌(PHO SEASON)’ 설립과 ‘햅쌀 쌀국수면’ 생산은 쌀국수 시장 선두주자로서의<br>\n");
      out.write("\t\t\t\t\t\t\t책임감과 ‘안전하고 정직한 먹거리’를 제공하겠다는 고객들을 향한 진심이 담긴 여정이었습니다.<br><br>\n");
      out.write("\t\t\t\t\t\t\t수년간의 도전의 결실, 포메인 ‘햅쌀 쌀국수면’은 오직 포메인에서 만날 수 있습니다.<br><br>\n");
      out.write("\t\t\t\t\t\t\t앞으로도 포메인으로부터 시작되는 변화와 도전이 쌀국수 시장의 기준이 될 수 있도록 원칙과 정직함이라는<br>\n");
      out.write("\t\t\t\t\t\t\t본질을 잃지 않고 쌀국수 시장의 중심에서 변화를 선도하겠습니다.\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t<div class=\"pho-season\">\n");
      out.write("\t\t\t\t\t\t\t<p class=\"txt\"><span>안전한 식재료 정직한 먹거리, </span>포시즌(PHO SEASON)</p>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"/company/rnd/phoseason.do\" class=\"btn-pho-season\">포시즌 자세히 보기</a>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
