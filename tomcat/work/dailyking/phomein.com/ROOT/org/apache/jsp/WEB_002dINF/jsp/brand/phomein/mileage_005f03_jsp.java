 ...
 * Generated at: 2021-02-26 07:48:22 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<h2 class=\"h2-type\">멤버십</h2>\n");
      out.write("\t\t\t<span class=\"txt\">포메인의 멤버쉽 서비스를 소개합니다.<br>간편 조회로 편하게 포메인 마일리지 서비스를 만나보세요.</span>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<!-- //page-title -->\n");
      out.write("\n");
      out.write("\t\t");
      ...
      out.write("\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t<li><a href=\"/brand/phomein/member_ship.do\">멤버십 안내</a></li>\n");
      out.write("\t\t\t\t\t\t<li><a href=\"/brand/phomein/mileage_01.do\">마일리지 조회</a></li>\n");
      out.write("\t\t\t\t\t\t<li class=\"actived\"><a href=\"#\">마일리지 통합</a></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<!-- //page-tab -->\n");
      out.write("\t\t\t\t<!-- data-con -->\n");
      ...
      out.write("\t\t\t\t\t\t<h3 class=\"h3-type fc01\">기존 카드 마일리지 조회</h3>\n");
      out.write("\t\t\t\t\t\t<span class=\"txt\">보유하고 계신 플라스틱 카드 정보를 입력 후 현재 마일리지를<br> 확인하시기 바랍니다.</span>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t<div class=\"table-list-data mt60\">\n");
      out.write("\t\t\t\t\t\t<div class=\"text-info\"><span class=\"need\"></span>는 필수입력 항목입니다.</div>\n");
      out.write("\t\t\t\t\t\t<fieldset>\n");
      out.write("\t\t\t\t\t\t\t<legend>마일리지 카드번호 입력 폼</legend>\n");
      out.write("\t\t\t\t\t\t\t<table class=\"view\">\n");
      out.write("\t\t\t\t\t\t\t\t<caption>마일리지 카드번호 입력 폼 테이블</caption>\n");
      out.write("\t\t\t\t\t\t\t\t<colgroup>\n");
      out.write("\t\t\t\t\t\t\t\t\t<col style=\"width:230px\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<col style=\"width:auto\">\n");
      out.write("\t\t\t\t\t\t\t\t</colgroup>\n");
      out.write("\t\t\t\t\t\t\t\t<tbody>\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr class=\"bg-col\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th scope=\"row\"><span class=\"need\"></span> 마일리지 카드번호</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"card-num-input\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"cell\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"card-num-01\" id=\"card-num-01\" class=\"onlyNumber\" value=\"\" maxlength=4 style=\"width:95px\" title=\"카드번호 첫번째 4자리\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"cell\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"card-num-02\" id=\"card-num-02\" class=\"onlyNumber\" value=\"\"  maxlength=4 style=\"width:95px\" title=\"카드번호 두번째 4자리\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"cell\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"card-num-03\" id=\"card-num-03\" class=\"onlyNumber\" value=\"\"  maxlength=4 style=\"width:95px\" title=\"카드번호 세번째 4자리\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"cell\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"card-num-04\" id=\"card-num-04\" class=\"onlyNumber\" value=\"\"  maxlength=4 style=\"width:95px\" title=\"카드번호 네번째 4자리\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"javascript:;\" id=\"searchMileageBtn\" class=\"btn-02 type-02\">조회</a>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t</tbody>\n");
      ...
      out.write("\t\t\t\t\t\t<li>마일리지 확인 후 본인인증을 통하여 마일리지를 통합 신청을 하실 수 있습니다.</li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"txt-box mt30\">\n");
      out.write("\t\t\t\t\t\t\t<p>입력된 카드드번호에 대한 마일리지는 <span id=\"point\"></span> 점 입니다.</p>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t<!-- btn-box -->\n");
      ...
      out.write("\tdocument.successForm.action = \"/brand/phomein/mileage_04.do\";\n");
      ...
      out.write("\t\t$.ajax({\n");
      out.write("            url: \"/brand/phomein/get_card_to_mileage.do\",\n");
      out.write("            type: \"POST\",\n");
