 ...
 * Generated at: 2021-02-11 01:54:08 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t<!-- //타이틀 영역 -->\n");
      out.write("\t\t\t\t<!-- 지도 영역 -->\n");
      out.write("\t\t\t\t<div class=\"map_area\">\n");
      out.write("\t\t\t\t\t<img src=\"../common/images/@temp/map_640x296.jpg\" alt=\"\" style=\"width:100%;\">\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<!-- //지도 영역 -->\n");
      out.write("\t\t\t\t<!-- table -->\n");
      ...
      out.write("\t\t\t\t\t\t<colgroup>\n");
      out.write("\t\t\t\t\t\t\t<col style=\"width:76px;\">\n");
      out.write("\t\t\t\t\t\t\t<col>\n");
      out.write("\t\t\t\t\t\t</colgroup>\n");
      out.write("\t\t\t\t\t\t<tbody>\n");
      out.write("\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<th scope=\"row\"><span>대표번호</span></th>\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"vam\"><span><strong>1899-2422</strong></span></td>\n");
      out.write("\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<th scope=\"row\"><span>주소</span></th>\n");
      out.write("\t\t\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<span><strong>경기도 성남시 분당구 황새울로 216<br>휴맥스빌리지 4층 ㈜데일리킹</strong></span>\n");
      out.write("\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<th scope=\"row\"><span>교통편</span></th>\n");
      out.write("\t\t\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<strong>지하철<em>:</em></strong>수내역 3번 출구 도보 약 2분\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<strong>버스<em>:</em></strong>수내역.롯데백화점 하차\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span><strong>일반</strong>17, 33, 52, 55-1, 250, 300, 380, 390, 520</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span><strong>직행</strong>102, 1241, 5500-1, 7007-1, 9414, G8110, 8106, 8109</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<strong>자동차<em>:</em></strong>네비게이션 이용 시 ‘데일리킹’<br>또는 ‘휴맥스빌리지’ 검색<br>(휴맥스빌리지 건물 주차 가능)\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</li>\t\n");
      out.write("\t\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t</tr>\n");
