 ...
 * Generated at: 2021-02-26 08:54:09 UTC
...
public final class greenfood_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<div class=\"visual\" style=\"background-image:url('/brand/images/sub/bg_02.png');\"></div>\n");
      out.write("\t\t\t<h2 class=\"h2-type\">현대그린푸드MOU</h2>\n");
      ...
      out.write("\t\t\t\t\t<h3 class=\"h3-type\">현대그린푸드<br>‘안전한 식자재 공급 MOU’</h3>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t<div class=\"greenfood-box\">\n");
      out.write("\t\t\t\t\t<div class=\"greenfood-con\">\n");
      out.write("\t\t\t\t\t\t<p class=\"txt load-fadein\">포메인은 식약처의 <br>‘위해상품 차단 시스템’ 을 갖춘 종합식품기업<br>‘현대그린푸드’와 함께 건강한 테이블을 만들어 갑니다.</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"tit load-fadein\">Relief <span>Phomein</span></p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt2 load-fadein\">포메인과 현대그린푸드는 지난 2016년 8월<br>‘안전한 식자재 공급’ 에 대한 업무협약을 체결하였습니다.<br><br>포메인은 전 가맹점 식자재 유통 경로 일원화를 추진 중이며, <br>현대그린푸드를 통해 식자재를 유통 받는 가맹점에서는<br>‘Relief Phomein’ 인증 마크를 확인할 수 있습니다.</p>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
