 ...
 * Generated at: 2021-02-26 10:23:54 UTC
...
return;
    ...
    try {
      ...
      out.write("\n");
      out.write("<style>\n");
      out.write(".video_con {width: 100%; margin:0 auto; height: 580px; text-align:center; border-bottom:1px solid #ddd; margin-bottom:30px;}\t\n");
      out.write("</style>\n");
      out.write("\n");
      out.write("<body>\n");
      out.write("<!-- skip-link -->\n");
      ...
      out.write("\t\t\t\t<iframe width=\"800\" height=\"515\" src=\"https://www.youtube.com/embed/ez0V9lfBnBU\" frameborder=\"0\" allow=\"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>\n");
      out.write("\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t<p class=\"txt02 load-fadein\">2021년, 더욱 단단해진 경쟁력으로 <span>지금 이 자리에 서 있습니다.</span></p>\n");
      ...
      out.write("\t\t\t\t\t\t<p class=\"txt03 load-fadein\">동종업계의 타 브랜드가 너 나 할 것 없이 유행을 좇을 때 <br>원칙과 정직함이라는 중심을 잃지 않고 도전을 이어나가는 것, <br>따라 할 수는 있어도 따라올 수 없는 <br>차이를 만드는 힘입니다.</p>\n");
      ...
      out.write("\t\t\t\t\t<p class=\"txt\">베트남 요리, <span><em>32</em>가지 감동을 담다!</span></p>\n");
