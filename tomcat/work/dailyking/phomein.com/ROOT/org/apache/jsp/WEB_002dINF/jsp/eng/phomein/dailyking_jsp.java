 ...
 * Generated at: 2020-01-11 23:57:10 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\tFounded in 2006, DAILYKING INC. is an incorporated enterprise which settled the rice noodle<br> \n");
      ...
      out.write("\t\t\t\t\t\t\tUnder the motto of 'Safe Food Ingredients and Honest Food', DAILYKING INC. has signed <br>a business agreement with 'Hyundai Green Food', supplying safe and fresh food ingredients to each franchise stores.\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt02 load-fadein\">\n");
      ...
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt02 load-fadein\" style=\"color:#333;\">\n");
      ...
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt02 load-fadein\">\n");
      out.write("\t\t\t\t\t\t\tThe domestic rice noodle market relies on imported rice noodles mixed with old rice, starch, and flour.<br>  However, the concept shift of making rice noodles only with fresh rice and purified water may have seemed reckless <br>to some people or as an unnecessary path of suffering.<br>It seems impossible to change what is already there, until you decide to take the first step.\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt02 load-fadein\">\n");
      out.write("\t\t\t\t\t\t\tFor DAILYKING INC., however, the establishment of ‘PHO SEASON’ and the production of ‘Fresh Rice Noodle’ were part of<br>a heartfelt journey towards customers to provide ‘safe and honest food‘ as a leader in the rice noodle market.<br>You can find Phomein’s ‘Fresh Rice Noodle’, the result of years of challenge, only at Phomein.\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt02 load-fadein\">\n");
      out.write("\t\t\t\t\t\t\tWe will lead changes at the center of the rice noodle market without losing the essence of principle<br>and honesty so that changes and challenges starting from Phomein.<br>We will become a new standard not only in Korea but also in the global rice noodle market.\n");
      out.write("\t\t\t\t\t\t</p>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<span>Diverse tastes</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!-- <strong>Pleasure of various selections<br />depending on mood and preference</strong> -->\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t\t<li class=\"load-fadein\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/img_keyword_02.jpg\" alt=\"\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span>Pleasure</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!-- <strong>It could be enjoyed by everyone regardless<br />of sex or age without burdens.</strong> -->\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t\t<li class=\"load-fadein\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/img_keyword_03.jpg\" alt=\"\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span>Newness</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!-- <strong>It always researches and challenges for<br />the newness with no fear.</strong> -->\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t</div>\n");
