 ...
 * Generated at: 2020-01-13 11:57:37 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t<h4>現代グリーンフード<br>「安全な食材供給MOU」</h4>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"content\">\n");
      out.write("\t\t\t\t\t<p class=\"txt1\">\n");
      out.write("\t\t\t\t\t\tフォーメインは食薬処の「危害商品遮断システム」を取り揃えた総合食品企業の「現代グリーンフード」と共に元気なテーブルを作って行きます。\n");
      out.write("\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t<p class=\"txt2\">\n");
      out.write("\t\t\t\t\t\t<strong>Relief Phomein</strong>\n");
      out.write("\t\t\t\t\t\t<span>\n");
      out.write("\t\t\t\t\t\t\tフォーメインと現代グリーンフードは去る2016年8月「安全な食材供給」に関する業務協約を締結しました。フォーメインは全店食材流通経路の一元化を推進中で、現代グリーンフードを通じ食材が流通される加盟店では、「Relief Phomein」認証マークを確認することができます。\n");
      out.write("\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t</p>\n");
