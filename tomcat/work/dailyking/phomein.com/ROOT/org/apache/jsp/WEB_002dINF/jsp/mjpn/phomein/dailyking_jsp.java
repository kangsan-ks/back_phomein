 ...
 * Generated at: 2020-01-12 07:51:34 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t㈱デイリーキングは2006年に設立、韓国内にライスヌードルのフランチャイズブランドである「フォーメイン」を定着させて、ベトナム料理の外食文化を大衆化させた法人企業です。\n");
      out.write("\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t<p class=\"txt2\">\n");
      out.write("\t\t\t\t\t\t「安全な食材の正直な食べ物」という理念の下で、2015年ベトナム現地法人ライスヌードル工場「フォーシーズン(PHO SEASON)」を設立して新米ライスヌードル麺と上級香辛料を使った肉水用ハーブバッグ(Herb Bags)の開発に成功しました。\n");
      out.write("\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t<p class=\"txt2\">\n");
      out.write("\t\t\t\t\t\tこれからもフォーメインから始まる変化と挑戦がライスヌードル市場の基準になれるように原則と正直という本質を失わずに、ライスヌードル市場の中心にて変化を善導します。\n");
      out.write("\t\t\t\t\t</p>\n");
