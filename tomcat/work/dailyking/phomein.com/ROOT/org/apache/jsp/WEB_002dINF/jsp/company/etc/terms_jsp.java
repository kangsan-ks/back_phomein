 ...
 * Generated at: 2021-02-25 09:59:17 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<li>회원ID : 이용자 식별과 서비스이용을 위하여 이용자가 선정하고 (주)데일리킹 포메인이 부여하는 영문자와 숫자의 조합.</li>\n");
      ...
      out.write("\t\t\t\t\t\t소요될 경우 회원에게 그 사유와 처리 일정 알려주어야 합니다.</li>\n");
