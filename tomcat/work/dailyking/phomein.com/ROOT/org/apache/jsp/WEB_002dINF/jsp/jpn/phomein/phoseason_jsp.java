 ...
 * Generated at: 2020-01-11 21:21:02 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<h2 class=\"h2-type\">フォーシーズン(PHO SEASON)</h2>\n");
      ...
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<p class=\"tit load-fadein\">フォーシーズン(PHO SEASON)は、</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt load-fadein\">2015年フォーメインで設立したベトナム現地ライスヌードル製造工場で、<br>\n");
      out.write("\t\t\t\t\t\t\tベトナムのMekong delta地域で収獲される清くて透明な新米で作ったライスヌードル麺と、<br>\n");
      out.write("\t\t\t\t\t\t\t9種の上級天然香辛料を使った肉水用ハーブバッグ(Herb-Bags)を生産しています。</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt load-fadein\">海外ライスヌードル麺の工産品に依存してきた国内ライスヌードル市場で、<br>\n");
      out.write("\t\t\t\t\t\t\tライスヌードルブランドが自体の技術開発でライスヌードル麺を生産したことはフォーメインが唯一です。<br>フォーシーズンの設立によるフォーメインの差別化は、国内だけではなく世界ライスヌードル市場の新しい基準になります。</p>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t<div class=\"inner02\">\n");
      out.write("\t\t\t\t\t\t<div class=\"bottom-visual-con\">\n");
      out.write("\t\t\t\t\t\t\t<p class=\"tit load-fadein\">米一粒からライスヌードル一丁まで</p>\n");
      out.write("\t\t\t\t\t\t\t<p class=\"txt load-fadein\">ポメインでは古米と澱粉または小麦粉を混合して作った既存のライスヌードル麺とは全く違った<br>\n");
      out.write("\t\t\t\t\t\t\t\tフォーメイン新米ライスヌードル麺の透明な色回りと炊き上げたままの新米ご飯の香が感じられます。<br>また、深くて濃い天然香辛料の香と味は、食材料が重要になった現代社会に強力な競争力になります。\n");
      out.write("\t\t\t\t\t\t\t</p>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<div class=\"phoseason-list\">\n");
      out.write("\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_phoseason_01.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"tit2\">1年4季節、新米</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt2\">ライスヌードル乾麺の生産に相応しい気候と環境であるベトナム、特に3模作が可能なMekong delta地域より1年始終新鮮な米が供給されます。フォーメインライスヌードル麺は、古米ではない新米のみを使ってライスヌードル乾麺を作ります。</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_phoseason_02.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"tit2\">とても清い、精製水</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt2\">フォーメインライスヌードル麺の製造過程で新米ほど重要な水もフォーシーズンの精製技術を通じ残留医薬品と環境ホルモンなど70種余りに汚染物質を除去したきれいな水(精製水)を使います。</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_phoseason_03.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"tit2\">独自技術、機械乾燥</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt2\">老後化された他のライスヌードル工場とは違い、フォーメインが独自で開発した機械乾燥技術で衛生的な乾燥が行われます。この過程で白く透明な色回りは生かしながらも新米ご飯の香りをそっくり盛り出します。</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_phoseason_04.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"tit2\">麺の完成、低温熟成</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt2\">不要な化学添加物を使わないために低温で熟成過程を通します。適当な粘りと柔らかさ、麺の弾力性を2倍も引き上げてくれるフォーメインの技術が集約されています。</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_phoseason_05.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"tit2\">名品肉水、ハーブバッグ</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt2\">9種の上級天然香辛料を使った肉水用ハーブバッグ(Herb-Bags)は、持続的な品質改善の再整備を実施します。フォーメイン最上の肉水味と質を維持する秘訣です。</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
