 ...
 * Generated at: 2021-01-06 13:20:38 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t<h4>CEO</h4>\n");
      out.write("\t\t\t\t<!-- <p class=\"desc\">고객의 만족을 위해 <br>최선을 다해 노력하겠습니다.</p> -->\n");
      out.write("\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t<span>Welcoming the 15th year<br>as of today, We will continue to keep our own principles.</span>\n");
      out.write("\t\t\t\t</p>\n");
      ...
      out.write("\n");
      out.write("\t\t\t\t\t\tPlease experience the appropriate glutinosity, the softness, and the chewiness of Phomein’s Fresh Rice Noodles which were born with Phomein’s exclusive low-temperature ripening technique. This process helps to avoid using unnecessary chemical additives.\n");
      out.write("\t\t\t\t\t\t<br><br>\n");
      out.write("\n");
