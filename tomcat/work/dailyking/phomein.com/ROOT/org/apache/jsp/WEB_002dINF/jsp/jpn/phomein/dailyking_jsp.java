 ...
 * Generated at: 2020-01-14 03:10:53 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t㈱デイリーキングは2006年に設立、韓国内にライスヌードルのフランチャイズブランドで<br>ある「フォーメイン」を定着させて、ベトナム料理の外食文化を大衆化させた法人企業です。\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt02 load-fadein\">\n");
      out.write("\t\t\t\t\t\t\t「安全な食材の正直な食べ物」という理念の下で、2015年ベトナム現地法人ライスヌードル工場「フォーシーズン(PHO SEASON)」<br>を設立して新米ライスヌードル麺と上級香辛料を使った肉水用ハーブバッグ(Herb Bags)の開発に成功しました。\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt02 load-fadein\">\n");
      out.write("\t\t\t\t\t\t\tこれからもフォーメインから始まる変化と挑戦がライスヌードル市場の基準になれるように<br>原則と正直という本質を失わずに、ライスヌードル市場の中心にて変化を善導します。\n");
      out.write("\t\t\t\t\t\t</p>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<span>多彩な味</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!-- <strong>気分や好みに合わせて選ぶ楽しみがあります。</strong> -->\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t\t<li class=\"load-fadein\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/img_keyword_02.jpg\" alt=\"\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span>楽しみ</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!-- <strong>老若男女を問わず、誰でも気軽にお楽しみいただけます。</strong> -->\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t\t<li class=\"load-fadein\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/img_keyword_03.jpg\" alt=\"\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span>新しさ</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!-- <strong>新しさについて常に研究し、果敢に挑戦します。</strong> -->\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t</div>\n");
