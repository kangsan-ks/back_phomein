 ...
 * Generated at: 2021-02-26 09:21:49 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t<div class=\"sub_visual sv1\" style=\"background-image: url('/mcompany/common/images/content/img_sv1_3.jpg');\">\n");
      out.write("\t\t\t<h3>CEO 인사말</h3>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<!-- 상단비쥬얼 영역\n");
      ...
      out.write("\t\t\t<div class=\"ceo_title\">\n");
      out.write("\t\t\t\t<h4>CEO <em>인사말</em></h4>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div class=\"ceo_intro\">\n");
      out.write("\t\t\t\t<h5>\n");
      out.write("\t\t\t\t\t<em>어떻게 만들까</em>에 대한 고민과 열정으로<br/><em>쌀국수 본질</em>을 좇으며 노력하고 있습니다.\n");
      out.write("\t\t\t\t</h5>\n");
      out.write("\t\t\t\t<p class=\"txt01\">\n");
      out.write("\t\t\t\t\t안녕하십니까?<br/>\n");
      out.write("\t\t\t\t\t주식회사 데일리킹 대표 김대일입니다.<br/>\n");
      out.write("\t\t\t\t\t<br/>\n");
      out.write("\t\t\t\t\t지난 한 해 코로나 팬데믹으로 외식업 전체가<br/>\n");
      out.write("\t\t\t\t\t힘든 시기를 보냈습니다.<br/>\n");
      out.write("\t\t\t\t\t모든 자영업자분이 한마음으로 혼신의 노력을 다한<br/>\n");
      out.write("\t\t\t\t\t시기가 아니었나 생각해봅니다. <br/>\n");
      out.write("\t\t\t\t\t<br/>\n");
      out.write("\t\t\t\t\t최근 다양한 이슈로 건강 및 면역 등 안전한 식재료에 대한 관심과<br/>\n");
      out.write("\t\t\t\t\t외식 패턴의 변화로 딜리버리 서비스 수요가 급증한 가운데,<br/>\n");
      out.write("\t\t\t\t\t<br/>\n");
      out.write("\t\t\t\t\t2014년 최초로 시작한 쌀국수 딜리버리 서비스로<br/>\n");
      out.write("\t\t\t\t\t축적해온 노하우와 2016년 현대그린푸드 MOU를 통한<br/>\n");
      out.write("\t\t\t\t\t위해 상품 차단 시스템으로 정직한 먹거리, 완성도 높은 서비스를<br/>\n");
      out.write("\t\t\t\t\t실행해온 포메인은 위기 속에서도 중심을 잃지 않기 위해<br/>\n");
      out.write("\t\t\t\t\t다분한 노력을 기울이고 있습니다.<br/>\n");
      out.write("\t\t\t\t\t<br/>\n");
      out.write("\t\t\t\t\t특히 2015년 현지법인 쌀국수 공장<br/>\n");
      out.write("\t\t\t\t\t포시즌(PHO SEASON) 설립과 독자기술 연구개발로 생산한<br/>\n");
      out.write("\t\t\t\t\t국내 최초, 국내 유일 ‘햅쌀면’은 묵은쌀 쌀국수면 수입으로<br/>\n");
      out.write("\t\t\t\t\t외산 일색이던 위기의 국내 쌀국수 시장에서<br/>\n");
      out.write("\t\t\t\t\t견고한 브랜드 경쟁력을 입증하고 있습니다. <br/>\n");
      out.write("\t\t\t\t\t<br/>\n");
      out.write("\t\t\t\t\t쌀국수 특유의 면 냄새 없는 향긋함,<br/>\n");
      out.write("\t\t\t\t\t독자기술로 완성한 쫀득한 식감까지<br/>\n");
      out.write("\t\t\t\t\t이제, 포메인의 건강한 ‘햅쌀 쌀국수’와 함께 하시길 바랍니다.<br/>\n");
      out.write("\t\t\t\t\t<br/>\n");
      out.write("\t\t\t\t\t2006년 포메인 분당 정자본점을 시작으로 <br/>\n");
      out.write("\t\t\t\t\t국내 베트남 외식 시장을 선도해온 포메인이 <br/>\n");
      out.write("\t\t\t\t\t올해로 창립 15주년을 맞았습니다.<br/>\n");
      out.write("\t\t\t\t\t<br/>\n");
      out.write("\t\t\t\t\t오늘도 우리는<br/>\n");
      out.write("\t\t\t\t\t‘어떻게 팔까’가 아닌 <br/>\n");
      out.write("\t\t\t\t\t‘어떻게 만들까’에 대한 고민과 열정으로 <br/>\n");
      out.write("\t\t\t\t\t마케팅이 아닌 ‘쌀국수 본질’을 좇으며 노력하고 있습니다.<br/>\n");
      out.write("\t\t\t\t\t<br/>\n");
      out.write("\t\t\t\t\t2021년에도 대한민국 쌀국수를 대표하는 브랜드로 <br/>\n");
      out.write("\t\t\t\t\t국내 쌀국수 시장의 변화와 도전에 앞장서도록 하겠습니다.<br/>\n");
      out.write("\t\t\t\t\t늘 건강하시길 바랍니다. 감사합니다. <br/>\n");
      out.write("\t\t\t\t</p>\n");
