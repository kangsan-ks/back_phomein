 ...
 * Generated at: 2021-02-26 09:19:13 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<li class=\"nav_cate_btn\"><a href=\"/mcompany/franchisee/step01.do\">브랜드 파워</a></li>\n");
      out.write("\t\t\t\t\t\t<li class=\"nav_cate_btn\"><a href=\"/mcompany/franchisee/step02.do\">지원시스템</a></li>\n");
      out.write("\t\t\t\t\t\t<li class=\"nav_cate_btn on\"><a href=\"#none\">개설절차</a></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write(" \t\t\t\t</div>\n");
      out.write("\t\t\t\t<!-- //카테고리 메뉴 -->\n");
      out.write("\t\t\t\t<div class=\"cont\">\n");
      out.write("\t\t\t\t\t<h5 class=\"tit\">가맹 절차</h5>\n");
      out.write("\t\t\t\t\t<ol class=\"list\">\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<em>01</em>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>가맹문의</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<p>창업 문의 상담 신청 전반적인 사업 설명</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<em>02</em>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>시장조사</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<p>가맹점 후보지 선정</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<em>03</em>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>입점지 선정</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<p>상권, 입지, 사업 타당성 분석</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<em>04</em>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>가맹계약</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<p>정보공개서 제공 가맹 계약 체결</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<em>05</em>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>인력채용</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<p>주방/ 홀 직원 채용</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<em>06</em>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>매장시설 공사</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<p>주방/ 홀 직원 채용 주방설비 계약 및 공사</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<em>07</em>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>본점교육</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<p>이론, 실습, 현장교육 (분당 정자본점 전문교육장)</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<em>08</em>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>영업준비</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<p>물품 공급 / 인.허가 증명서 발급 / 전체 점검</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<em>09</em>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>개점</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<p>온.오프라인 홍보 오픈 이벤트 진행</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<em>10</em>\n");
      out.write("\t\t\t\t\t\t\t\t<strong>사후관리</strong>\n");
      out.write("\t\t\t\t\t\t\t\t<p>안정적인 물품 공급 슈퍼바이저 지원</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"http://www.phomein.com/mcompany/franchisee/terms.do\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<strong style=\"display:block;\">가맹 신청</strong>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p style=\"display:inline-block; font-size:15px; margin:10px 0; padding:6px 18px; background-color:#525252; color:#fff; border-radius:4px;\">바로가기</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p style=\"font-size:15px;\">대표 전화 : 1899-2422</p>\n");
      out.write("\t\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t</ol>\n");
