 ...
 * Generated at: 2021-02-11 07:19:41 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t<h4>이메일무단수집거부</h4>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<!-- //타이틀 영역 -->\n");
      out.write("\t\t\t<div class=\"policy_cont\">\n");
      out.write("\t\t\t\t<h5 class=\"tit\">정보통신망 이용촉진 및 정보보호 등에 관한 법률</h5>\n");
      ...
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<h5 class=\"tit\">제50조의 2(전자우편주소의 무단 수집행위 등 금지)</h5>\n");
      out.write("\t\t\t\t<ul class=\"txt\">\n");
      out.write("\t\t\t\t\t<li>- 누구든지 인터넷 홈페이지 운영자 또는 관리자의 사전 동의 없이 인터넷 홈페이지에서 자동으로 전자우편주소를 수집하는 프로그램이나 그 밖의 기술적 장치를 이용하여 전자우편주소를 수집하여서는 아니 된다.</li>\n");
      ...
      out.write("\t\t\t\t</ul>\n");
      out.write("\t\t\t\t<h5 class=\"tit\">제74조(벌칙)</h5>\n");
      out.write("\t\t\t\t<ul class=\"txt\">\n");
      out.write("\t\t\t\t\t<li>- 다음 각 호의 어느 하나에 해당하는 자는 1년 이하의 징역 또는 1천만원 이하의 벌금에 처한다.</li>\n");
      out.write("  \t\t\t\t\t<li>- 제50조의 2를 위반하여 전자우편주소를 수집·판매·유통하거나 정보 전송에 이용한 자.</li>\n");
      out.write("\t\t\t\t</ul>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<!-- //content -->\n");
