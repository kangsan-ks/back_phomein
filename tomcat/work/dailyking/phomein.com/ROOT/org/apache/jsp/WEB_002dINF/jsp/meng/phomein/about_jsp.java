 ...
 * Generated at: 2020-12-31 04:45:55 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t<strong><span>With stronger<br>competitiveness in 2021,</span><em>Phomein has accomplished<br> great growth. </em></strong>\n");
      out.write("\t\t\t\t</p>\n");
      out.write("\t\t\t\t<p class=\"txt2\">\t\n");
      out.write("\t\t\t\t\tAll menus of Phomein use <br>“freshly harvested rice noodles” self-made at the\n");
      out.write("\t\t\t\t\trice noodle<br>  manufacturing factory “PHO SEASON’ in Vietnam.<br>In a rice noodle market relying on imported<br>  rice noodles made of old rice, you can meet the<br> clean and healthy “Fresh Rice Noodles” only at Phomein.<br><br>\n");
      out.write("\t\t\t\t\tWholesome rice noodles made from freshly<br> harvested rice 365 days a year to\n");
      out.write("\t\t\t\t\tluxurious meat<br> broth further deepened with quality improvement<br>\n");
      out.write("\t\t\t\t\t<em style=\"padding-top:0;\">Phomein is it for rice noodles.</em><br><br>\n");
      out.write("\t\t\t\t\tOther brands in the foodservice industry are busy <br>chasing trends without exception.\n");
      out.write("\t\t\t\t\tOn the basis of principles<br> and honesty, Phomein has taken challenges and strengthened<br> its competitiveness.\n");
      out.write("\t\t\t\t\tThanks to these efforts, Phomein possesses <br>unrivalled competitiveness as of now.\n");
      out.write("\n");
      out.write("\n");
      out.write("\t\n");
      out.write("\n");
      out.write("\t\t\t\t\t<em>Now and here, the one and only Phomein is with you.</em>\n");
      out.write("\t\t\t\t<p>\n");
