 ...
 * Generated at: 2020-01-12 13:28:16 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<h2 class=\"h2-type\">PHO SEASON</h2>\n");
      ...
      out.write("\t\t\t\t\t<h3 class=\"h3-type2\">PHO SEASON</h3>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t\t\t<p class=\"txt load-fadein\">PHO SEASON is a rice noodle manufacturing factory established by Phomein in 2015.<br> It produces rice noodles made of clear and transparent fresh rice harvested in Mekong Delta, Vietnam.<br>Also produces Herb-Bags for meat broth using 9 kinds of high quality natural spices.</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt load-fadein\">Phomein is the only rice noodle brand that developed rice noodles with its own technology in the<br>domestic rice noodle market which has relied on imported rice noodles mixed with old rice, starch and flour.<br>The differentiation of Phomein due to the establishment of PHO SEASON <br>will become a new standard not only in Korea but also in the global rice noodle market.</p>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t<div class=\"inner02\">\n");
      out.write("\t\t\t\t\t\t<div class=\"bottom-visual-con\">\n");
      out.write("\t\t\t\t\t\t\t<p class=\"tit load-fadein\">From a grain of rice to a bowl of rice noodles.</p>\n");
      out.write("\t\t\t\t\t\t\t<p class=\"txt load-fadein\">In Phomein, you can feel the transparent color of Phomein's fresh rice noodle and the fragrance of freshly cooked new rice,<br>which are completely different from imported rice noodles mixed with old rice, starch and flour.<br>\n");
      out.write("\t\t\t\t\t\t\tIn addition, the taste and flavor of thick and deep natural spices are strong competitive power<br>in modern society where ingredients become important.\n");
      out.write("\t\t\t\t\t\t\t</p>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<div class=\"phoseason-list\">\n");
      out.write("\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_phoseason_01.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"tit2\">4 Seasons of Freshly Harvested Rice</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt2\">We receive fresh rice all year round from Vietnam, where it’s known for raising three crops a year. Especially Mekong Delta region has the perfect climate and environment for producing dried rice noodles.</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_phoseason_02.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"tit2\">Clear Purified Water</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt2\">In the PHO SEASON rice noodle manufacturing process, water is as important as freshly harvested rice. We use clean water (purified water) that removes about 70 kinds of pollutants such as residual drugs and environmental hormones through the PHO SEASON’s purification technology.</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_phoseason_03.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"tit2\">New Technology, Machine Drying</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt2\">Unlike the other obsolete noodle making factories, PHO SEASON has developed the way of drying rice noodles by using its own hygienic drying technology. In this process, the clear and transparent color of the newly harvested rice is saved and the fragrance of freshly cooked rice remains intact.</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_phoseason_04.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"tit2\">Completion of Noodles,<br> Low-temperature Ripening</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt2\">The ripening process is directed at low temperature to avoid using unnecessary chemical additives. PHO SEASON’s low-temperature ripening process doubles the appropriate glutinosity, the softness, and the chewiness of noodles.</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"img\"><img src=\"../images/content/ico_phoseason_05.png\" alt=\"icon\"/></p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"tit2\">Luxury meat broth, Herb-Bags</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"txt2\">Herb-Bags for meat broth using 9 kinds of high quality natural spices continue to improve its quality. It is the Phomein’s secret of maintaining the taste and quality of the best meat broth.</p>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
