 ...
 * Generated at: 2021-02-26 09:08:15 UTC
...
return;
    ...
    try {
      ...
      out.write("\n");
      out.write("/* red01 */\n");
      out.write(".red01-wrap{ text-align: center;}\n");
      out.write(".red01-wrap h2{font-size: 60px; line-height: 100px; text-align: center;}\n");
      ...
      out.write("\n");
      out.write(".img_wrap{overflow: hidden;}\n");
      out.write(".img_wrap img{    min-width: 1800px;\n");
      ...
      out.write("\t\t\t<div class=\"visual\" style=\"background-image:url('../images/content/sub_visual_08.jpg');\"></div>\n");
      out.write("\t\t\t<h2 class=\"h2-type\">딜리버리 서비스</h2>\n");
      ...
      out.write("\t\t\t\t<iframe width=\"1050\" height=\"590\" src=\"https://www.youtube.com/embed/LInM6QPlqLo\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div class=\"red-con\">\n");
      out.write("\t\t\t\t<div class=\"mt80\">\n");
      out.write("\t\t\t\t\t<div class=\"red01-wrap\">\n");
      out.write("\t\t\t\t\t\t<h2>\n");
      out.write("\t\t\t\t\t\t\tWHENEVER, WHEREVER<br/>PHOMEIN DELIVERY SERVICE\n");
      out.write("\t\t\t\t\t\t</h2>\n");
      out.write("\t\t\t\t\t\t<div class=\"red01-inner\">\n");
      out.write("\t\t\t\t\t\t\t<span>\n");
      out.write("\t\t\t\t\t\t\t\t2014년 업계 최초로 쌀국수 배달을 시행한 베트남 쌀국수 전문점 포메인은<br/>\n");
      out.write("\t\t\t\t\t\t\t\t언제 어디서든 쌀국수를 즐길 수 있는 환경을 조성하고자 딜리버리 사업에 뛰어들었습니다.<br/>\n");
      out.write("\t\t\t\t\t\t\t\t<br/>\n");
      out.write("\t\t\t\t\t\t\t\t분명 쉬운 길은 아니었지만 쌀국수 배달을 위해 포메인은 지난 7년 동안<br/>\n");
      out.write("\t\t\t\t\t\t\t\t여러 차례의 시범운영을 통한 패키지 리뉴얼 작업, 딜리버리 매뉴얼 제작으로<br/>\n");
      out.write("\t\t\t\t\t\t\t\t경쟁력을 쌓으며 가파르게 성장하는 딜리버리 시장에 성공적으로 안착했습니다.<br/>\n");
      out.write("\t\t\t\t\t\t\t\t<br/>\n");
      out.write("\t\t\t\t\t\t\t\t이제는 너도나도 쌀국수 배달에 뛰어드는 시대<br/>\n");
      out.write("\t\t\t\t\t\t\t\t포메인의 경쟁력은 하루아침에 만들어진 게 아니라는 걸 증명하듯<br/>\n");
      out.write("\t\t\t\t\t\t\t\t자체 개발 쌀국수 전용 패키지와 우리만의 노하우로 독보적인 서비스를 선보이고 있습니다.<br/>\n");
      out.write("\t\t\t\t\t\t\t\t특히 배달을 받아보았을 때 쌀국수면에서 느낄 수 있는 향긋한 햅쌀밥의 향은<br/>\n");
      out.write("\t\t\t\t\t\t\t\t애써 말하지 않아도 고객이 먼저 느끼는 포메인의 강점입니다.<br/>\n");
      out.write("\t\t\t\t\t\t\t\t<br/>\n");
      out.write("\t\t\t\t\t\t\t\t포메인만의 레시피로 재해석한 32가지의 베트남 요리를<br/>\n");
      out.write("\t\t\t\t\t\t\t\t언제, 어디서든 매장에서 즐기던 맛 그대로 만나보세요.\n");
      out.write("\t\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"img_wrap\">\n");
      out.write("\t\t\t\t\t\t\t<img src=\"../images/content/delivery01.jpg\" alt=\"\" />\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t</div>\n");
