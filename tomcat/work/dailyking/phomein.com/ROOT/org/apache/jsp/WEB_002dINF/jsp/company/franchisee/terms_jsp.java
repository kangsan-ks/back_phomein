 ...
 * Generated at: 2021-02-26 10:23:56 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<div class=\"visual\" style=\"background-image:url('../images/content/sub_visual_03_2.jpg');\"></div>\n");
      ...
      out.write("\t\t\t\t\t<div class=\"con-title\" style=\"margin-bottom:100px;\">\n");
      out.write("\t\t\t\t\t\t<h3 class=\"h3-type\" style=\"margin-bottom:60px;\">전화 가맹 문의</h3>\n");
      out.write("\t\t\t\t\t\t<p style=\"font-size:22px;\">\n");
      out.write("\t\t\t\t\t\t\t<span style=\"margin-right:50px;\">대표 번호 : 1899-2422 (연결 1)</span>\n");
      out.write("\t\t\t\t\t\t\t<span>직통 번호 : 031-780-1500</span>\n");
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<p style=\"font-size:18px; color:#444; margin:20px 0 50px;\">전화 상담 가능 시간 : 평일 8:50AM ~ 18:00PM (점심시간 11:50 ~ 13:00)</p>\n");
      out.write("\t\t\t\t\t\t<p style=\"font-size:17px; color:#555; width: 360px; padding:20px 30px; border:1px solid #222; text-align:left; margin:0 auto; line-height:29px;\">\n");
      ...
      out.write("\t\t\t\t\t\t<h3 class=\"h3-type\" style=\"margin-bottom:70px;\">온라인 가맹 문의</h3>\n");
      out.write("\t\t\t\t\t\t<h3 class=\"h3-type\" style=\"font-size:25px;\">개인정보 수집 및 이용동의</h3>\n");
