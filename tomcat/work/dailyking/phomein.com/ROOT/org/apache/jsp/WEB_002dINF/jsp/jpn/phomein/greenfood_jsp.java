 ...
 * Generated at: 2020-01-14 19:55:01 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<h2 class=\"h2-type\">現代グリーンフード</h2>\n");
      ...
      out.write("\t\t\t\t\t<h3 class=\"h3-type\">現代グリーンフード<br>「安全な食材供給MOU」</h3>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t<div class=\"greenfood-box\">\n");
      out.write("\t\t\t\t\t<div class=\"greenfood-con\">\n");
      out.write("\t\t\t\t\t\t<p class=\"txt load-fadein\">フォーメインは食薬処の「危害商品遮断システム」を取り揃えた総合食品企業の「現代グリーンフード」と共に元気なテーブルを作って行きます。</p>\n");
      out.write("\t\t\t\t\t\t<p class=\"tit load-fadein\">Relief <span>Phomein</span></p>\n");
      out.write("\t\t\t\t\t\t<p class=\"txt2 load-fadein\">フォーメインと現代グリーンフードは去る2016年8月「安全な食材供給」に関する業務協約を締結しました。フォーメインは全店食材流通経路の一元化を推進中で、現代グリーンフードを通じ食材が流通される加盟店では、「Relief Phomein」認証マークを確認することができます。</p>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\n");
