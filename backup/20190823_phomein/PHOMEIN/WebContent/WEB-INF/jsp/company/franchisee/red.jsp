...
.red03-tit p{font-size: 38px; line-height:32px; letter-spacing:0; font-weight: bold; color: #fff;}
.red03-tit i{width: 30px; height: 2px; margin: 20px auto 20px; font-style: normal; display: block; background: #fff;}
...
.red03-in > div strong{padding: 0 60px; margin-top: 15px; font-size: 15px; line-height:24px; letter-spacing:0; font-weight: 400; color: #999; display: block; text-align: left; box-sizing:border-box;}
/* red03 */

/* red04 */
.red04-wrap{}
.red04-bg{height: 350px; background: url(../images/red/red04-bg.png) center center no-repeat; background-size: cover;}
.red04-inner{width: 100%; max-width:1200px; margin: 0 auto 47px;}
.red04-inner p{padding: 80px 0 40px; font-size: 40px; line-height:54px; letter-spacing:0; font-weight: bold; color: #333;}
.red04-inner span{font-size: 19px; line-height:30px; letter-spacing:0; font-weight: 400; color: #666; display: block;}
/* red04 */
...
.red06-tit p{font-size: 40px; line-height:32px; letter-spacing:0; font-weight: bold; color: #fff;}
.red06-tit i{width: 30px; height: 2px; margin: 20px auto 20px; font-style: normal; display: block; background: #fff;}
		...
		<div id="contents" class="content">
			<div class="red-con">
				<div class="con-title">
					...
					<p class="n-txt">Rice noodle Express Delivery</p>
					<!-- //20190225 수정 -->
				</div>
				<div class="inner02 mt80">
						...
						<div class="red03-inner">
							...
							<div class="red03-in clear">
								<div class="red03-box">
									...
									<strong>※ 2015년도 통계청 통계플러스(KOSTAT)<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									프랜차이즈 현황 자료 발췌</strong>
								</div>
								<div class="red03-box">
					...
					<div class="red04-wrap">
						<div class="red04-inner red04-bg">
